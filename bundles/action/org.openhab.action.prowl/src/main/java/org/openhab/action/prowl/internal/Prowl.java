...
public class Prowl {
    ...
    static public boolean pushNotification(
        ...
        if (priority < -2) {
            ...
            logger.info("Prowl-Notification priority '{}' is invalid - normalized value to '{}'", priority,
                    normalizedPriority);
        } else if (priority > 2) {
            normalizedPriority = 2;
            logger.info("Prowl-Notification priority '{}' is invalid - normalized value to '{}'", priority,
        ...
        if (ProwlActionService.isProperlyConfigured) {
            ...
            logger.error(
                    "Cannot push Prowl notification because of missing configuration settings. The current settings are: "
                            + "apiKey: '{}', priority: {}, url: '{}'",
