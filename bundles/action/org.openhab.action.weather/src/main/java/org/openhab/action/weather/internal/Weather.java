...
public class Weather {
    ...
    public static double getHumidex(@ParamDoc(name = "Temperature") double temperature,
    ...
    public static int getBeaufortIndex(@ParamDoc(name = "WindSpeed") double speed) {
    ...
    public static String getWindDirection(@ParamDoc(name = "Orientation angle") int degree) {
