...
public class YamahaReceiverBindingConfig implements BindingConfig {
    ...
    public YamahaReceiverBindingConfig(String deviceUid, String zone, String bindingType, String itemName)
            throws BindingConfigParseException {
        this.deviceUid = deviceUid != null ? deviceUid : YamahaReceiverBinding.DEFAULT_DEVICE_UID;
