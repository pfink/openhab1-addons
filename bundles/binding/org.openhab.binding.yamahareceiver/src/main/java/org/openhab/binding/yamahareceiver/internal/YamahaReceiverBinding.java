 ...
 * @since 1.6.0
 */
public class YamahaReceiverBinding extends AbstractActiveBinding<YamahaReceiverBindingProvider>
    ...
    private Collection<YamahaReceiverBindingConfig> getDeviceConfigs(String deviceUid) {
    ...
    private void sendUpdate(Collection<YamahaReceiverBindingConfig> configs, Zone zone, BindingType type, State state) {
