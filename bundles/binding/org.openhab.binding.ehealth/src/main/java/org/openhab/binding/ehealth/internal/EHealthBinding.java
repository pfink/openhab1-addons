 ...
 * @since 1.6.0
 */
public class EHealthBinding extends AbstractBinding<EHealthBindingProvider>
        implements ManagedService, SerialEventProcessor {
    ...
    public void processSerialData(String data) {
        ...
        if (dataElements.length == 11) {
            ...
            EHealthDatagram datagram = new EHealthDatagram(airFlow, temperature, skinConductance, skinResistance,
                    skinConductanceVoltage, bpm, oxygenSaturation, bodyPosition, ecg, emg, glucose);
