 ...
 * {@link EHealthBindingProvider} service as well.
 * </p>
 *
 * <p>
 ...
 * <li><code>{ ehealth="skinResistance" }</code>
 * <li>
 * <li><code>{ ehealth="skinConductance" }</code>
 * <li>
 * </ul>
 *
...
public class EHealthGenericBindingProvider extends AbstractGenericBindingProvider implements EHealthBindingProvider {
    ...
    public void processBindingConfiguration(String context, Item item, String bindingConfig)
        ...
        try {
            ...
            throw new BindingConfigParseException(
                    "Invalid sensor property name '" + bindingConfig + "' > please fix your *.items accordingly!");
        }
