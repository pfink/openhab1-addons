...
public class BTDeviceDiscoveryService extends Thread implements ManagedService {
    ...
    final private Set<BluetoothEventHandler> eventHandler = Collections
            .synchronizedSet(new HashSet<BluetoothEventHandler>());
    ...
    public void updated(Dictionary config) throws ConfigurationException {
        if (config != null) {
            ...
            try {
                ...
                logger.warn("Invalid configuration value '{}' for parameter '" + SERVICE_PID + ":" + REFRESH_RATE + "'",
                        value);
            }
        }
    }
    ...
    public void run() {
        try {
            ...
            logger.debug("Initializing local bluetooth device ({}, {})", localDevice.getBluetoothAddress(),
            ...
            DiscoveryListener listener = new DiscoveryListener() {
                ...
                public void inquiryCompleted(int discType) {
                    ...
                    Iterable<BluetoothDevice> devices = Iterables.transform(newDevices,
