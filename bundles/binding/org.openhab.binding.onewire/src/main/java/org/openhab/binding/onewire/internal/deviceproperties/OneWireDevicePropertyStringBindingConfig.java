...
/**
 * This Class is a specialized writable BindingConfig. It connects openHab String-Items to 1-Wire device properties
 * (example: DS2408 with LCD connected)
 *
...
public class OneWireDevicePropertyStringBindingConfig extends AbstractOneWireDevicePropertyWritableBindingConfig {
    ...
    public String toString() {
        final int maxLen = 20;
        return "OneWireDevicePropertyStringBindingConfig [getDeviceId()=" + getDeviceId() + ", getPropertyName()="
