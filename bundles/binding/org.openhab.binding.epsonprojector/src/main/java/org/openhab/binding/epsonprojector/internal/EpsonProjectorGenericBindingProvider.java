 ...
 * @since 1.3.0
 */
public class EpsonProjectorGenericBindingProvider extends AbstractGenericBindingProvider
        implements EpsonProjectorBindingProvider {
    ...
    private void parseRefreshPeriod(String refreshPeriodString, EpsonProjectorBindingConfig config)
            throws BindingConfigParseException {
    ...
    private EpsonProjectorCommandType getCommandTypeFromString(String commandTypeString, Item item)
            throws BindingConfigParseException {
    ...
    static class EpsonProjectorBindingConfig implements BindingConfig {
        ...
        public String toString() {
            return "ExecBindingConfigElement [" + ", itemType=" + itemType + ", deviceID=" + deviceID + ", commandType="
                    + commandType + ", refreshInterval=" + refreshInterval + ", inBinding=" + inBinding + "]";
        }
