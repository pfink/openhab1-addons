...
public class ZWaveAlarmConverter extends ZWaveCommandClassConverter<ZWaveAlarmCommandClass> {
     ...
     */
    @Override
    public SerialMessage executeRefresh(ZWaveNode node, ZWaveAlarmCommandClass commandClass, int endpointId,
     ...
     */
    @Override
    public void receiveCommand(Item item, Command command, ZWaveNode node, ZWaveAlarmCommandClass commandClass,
