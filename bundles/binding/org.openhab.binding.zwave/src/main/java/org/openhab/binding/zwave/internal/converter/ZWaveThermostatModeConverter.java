 ...
 * @since 1.6.0
 */
public class ZWaveThermostatModeConverter extends ZWaveCommandClassConverter<ZWaveThermostatModeCommandClass> {
     ...
     */
    public ZWaveThermostatModeConverter(ZWaveController controller, EventPublisher eventPublisher) {
     ...
     */
    @Override
    SerialMessage executeRefresh(ZWaveNode node, ZWaveThermostatModeCommandClass commandClass, int endpointId,
     ...
     */
    @Override
    void receiveCommand(Item item, Command command, ZWaveNode node, ZWaveThermostatModeCommandClass commandClass,
