 ...
 * @since 1.6.0
 */
public class ZWaveThermostatOperatingStateConverter
        extends ZWaveCommandClassConverter<ZWaveThermostatOperatingStateCommandClass> {
     ...
     */
    public ZWaveThermostatOperatingStateConverter(ZWaveController controller, EventPublisher eventPublisher) {
     ...
     */
    @Override
    SerialMessage executeRefresh(ZWaveNode node, ZWaveThermostatOperatingStateCommandClass commandClass, int endpointId,
    ...
    void receiveCommand(Item item, Command command, ZWaveNode node,
            ZWaveThermostatOperatingStateCommandClass commandClass, int endpointId, Map<String, String> arguments) {
