 ...
 * @since 1.6.0
 */
public class ZWaveThermostatFanModeConverter extends ZWaveCommandClassConverter<ZWaveThermostatFanModeCommandClass> {
     ...
     */
    public ZWaveThermostatFanModeConverter(ZWaveController controller, EventPublisher eventPublisher) {
     ...
     */
    @Override
    SerialMessage executeRefresh(ZWaveNode node, ZWaveThermostatFanModeCommandClass commandClass, int endpointId,
     ...
     */
    @Override
    void receiveCommand(Item item, Command command, ZWaveNode node, ZWaveThermostatFanModeCommandClass commandClass,
