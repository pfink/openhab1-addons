...
public class ZWaveDoorLockConverter extends ZWaveCommandClassConverter<ZWaveDoorLockCommandClass> {
     ...
     */
    @Override
    public SerialMessage executeRefresh(ZWaveNode node, ZWaveDoorLockCommandClass commandClass, int endpointId,
     ...
     */
    @Override
    public void receiveCommand(Item item, Command command, ZWaveNode node, ZWaveDoorLockCommandClass commandClass,
