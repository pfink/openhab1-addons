...
public class ZWaveBinarySensorConverter extends ZWaveCommandClassConverter<ZWaveBinarySensorCommandClass> {
     ...
     */
    @Override
    public SerialMessage executeRefresh(ZWaveNode node, ZWaveBinarySensorCommandClass commandClass, int endpointId,
     ...
     */
    @Override
    public void receiveCommand(Item item, Command command, ZWaveNode node, ZWaveBinarySensorCommandClass commandClass,
