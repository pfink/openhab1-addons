# JSON configuration for _vaillant-vrc630_

ID                                            | Item type  | Description                                                
---                                           | ---        | ---                                                        
**controller.temp_d_flow**                    | ``Number`` | Flow temperature target value (°C)                         
**controller.temp_flow**.status               | ``Number`` | Flow temperature status - {0=Ok, 85=Circuit, 170=Cutoff}   
**controller.temp_flow**.temp_flow            | ``Number`` | Flow temperature                                           
