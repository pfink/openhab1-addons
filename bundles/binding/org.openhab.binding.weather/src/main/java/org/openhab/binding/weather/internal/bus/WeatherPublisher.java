                            ...
                            if (instance != null) {
                                ...
                                if (Weather.isVirtualProperty(weatherProperty)) {
                                    ...
                                    if (Weather.VIRTUAL_TEMP_MINMAX.equals(weatherProperty)) {
                                        Double min = UnitUtils.convertUnit(temp.getMin(), bindingConfig.getUnit(),
                                                bindingConfig.getWeatherProperty());
                                        Double max = UnitUtils.convertUnit(temp.getMax(), bindingConfig.getUnit(),
                                                bindingConfig.getWeatherProperty());
                                    ...
                                    if (bindingConfig.hasUnit()) {
                                        value = UnitUtils.convertUnit((Double) value, bindingConfig.getUnit(),
                                                bindingConfig.getWeatherProperty());
                                    }
                                }
