...
public class NestGenericBindingProvider extends AbstractGenericBindingProvider implements NestBindingProvider {
    ...
    private static class NestBindingConfig implements BindingConfig {
        ...
        public NestBindingConfig(final String property, final boolean inBound, final boolean outBound) {
        ...
        public String toString() {
            return "NestBindingConfig [property=" + this.property + ", inBound=" + this.inBound + ", outBound="
                    + this.outBound + "]";
        }
    }
