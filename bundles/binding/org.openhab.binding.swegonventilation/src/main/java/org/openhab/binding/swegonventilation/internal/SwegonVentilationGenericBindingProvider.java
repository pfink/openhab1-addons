 ...
 * @since 1.4.0
 */
public class SwegonVentilationGenericBindingProvider extends AbstractGenericBindingProvider
        implements SwegonVentilationBindingProvider {
    ...
    class SwegonVentilationBindingConfig implements BindingConfig {
        ...
        public String toString() {
            return "SwegonVentilationBindingConfig [" + ", itemType=" + itemType + ", commandType=" + commandType + "]";
        }
    ...
    public Class<? extends Item> getItemType(String itemName) {
        SwegonVentilationBindingConfig config = (SwegonVentilationBindingConfig) bindingConfigs.get(itemName);
