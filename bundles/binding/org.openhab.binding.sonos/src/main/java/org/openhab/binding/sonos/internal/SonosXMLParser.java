...
/**
 * XMLParser is a set of helper classes and methods to parse XML string that are returned by Sonos players in the
 * network, or that
        ...
        public void endElement(String uri, String localName, String qName) throws SAXException {
            ...
            if (qName.equals("Alarm")) {
                ...
                try {
                    ...
                    PeriodFormatter pFormatter = new PeriodFormatterBuilder().appendHours().appendSeparator(":")
                ...
                alarms.add(new SonosAlarm(finalID, finalStartTime, finalDuration, recurrence, finalEnabled, roomUUID,
                        programURI, programMetaData, playMode, finalVolume, finalIncludeLinkedZones));
            }
        ...
        public void startElement(String uri, String localName, String qName, Attributes atts) throws SAXException {
            ...
            try {
                if (atts.getValue("val") != null) {
                    StateVariable stateVariable = new StateVariable(localName,
                            new StateVariableTypeDetails(new StringDatatype()));
