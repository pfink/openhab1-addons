...
public class SonosGenericBindingProvider extends AbstractGenericBindingProvider implements SonosBindingProvider {
    ...
    private void parseBindingConfig(SonosBindingConfig config, Item item, String bindingConfig)
            throws BindingConfigParseException {
        ...
        if (bindingConfig != null) {
            ...
            if (!actionMatcher.matches() && !statusMatcher.matches()) {
                throw new BindingConfigParseException("Sonos binding configuration must consist of either two [config="
                ...
                SonosBindingConfigElement newElement = new SonosBindingConfigElement(sonosCommand, sonosID,
    ...
    static class SonosBindingConfigElement implements BindingConfig {
        ...
        public SonosBindingConfigElement(String sonosCommand, String sonosID,
        ...
        public String toString() {
            return "SonosBindingConfigElement [Direction=" + sonosCommand + ", id=" + id + ", type=" + "]";
        }
    ...
    public List<String> getItemNames(String sonosID, String sonosCommand) {
        ...
        for (String anItem : items) {
            ...
            for (Command command : aBindingConfig.keySet()) {
                SonosBindingConfigElement anElement = aBindingConfig.get(command);
                if (anElement.getSonosCommand().equals(sonosCommand) && anElement.getSonosID().equals(sonosID)
                        && !result.contains(anItem)) {
                    result.add(anItem);
                }
            }
        }
