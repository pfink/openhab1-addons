...
public final class HMSActivator implements BundleActivator {
    ...
    private static Logger logger = LoggerFactory.getLogger(HMSActivator.class);
    ...
    public void start(BundleContext bc) throws Exception {
        context = bc;
        logger.debug("HMS binding has been started.");
    }
    ...
    public void stop(BundleContext bc) throws Exception {
        context = null;
        logger.debug("HMS binding has been stopped.");
    }
