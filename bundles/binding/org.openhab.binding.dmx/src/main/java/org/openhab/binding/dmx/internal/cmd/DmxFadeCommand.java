 ...
 * <channel-values>
	: 	a csv list of target DMX values (0-255) for each of the main channels defined in the channel config.
 * 						These values are repeated automatically on all the mirror channels.
 * <hold-time>
		:	time to hold the target values in milliseconds.  A value of -1 will keep the value active indefinite.
 *
 * }
 *
...
public class DmxFadeCommand implements DmxCommand {
     ...
     */
    public DmxFadeCommand(DmxItem item, String cmd) throws BindingConfigParseException {
