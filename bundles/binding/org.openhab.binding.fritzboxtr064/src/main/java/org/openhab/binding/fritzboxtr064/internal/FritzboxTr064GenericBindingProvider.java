 ...
 * @since 1.8.0
 */
public class FritzboxTr064GenericBindingProvider extends AbstractGenericBindingProvider
        implements FritzboxTr064BindingProvider {
    ...
    public class FritzboxTr064BindingConfig implements BindingConfig {
        ...
        public String toString() {
            return "FritzboxTr064BindingConfig [itemType=" + itemType + ", configString=" + configString + "]";
        }
