...
public class RWESmarthomeSession {
     ...
     */
    public void setLogicalDevices(ConcurrentHashMap<String, LogicalDevice> logicalDevices) {
    ...
    public void destroy() {
        final String LOGOUT_REQUEST = String.format(
                ...
                FIRMWARE_VERSION, requestId, getSessionId());
        try {
     ...
     */
    public String executeRequest(String request, String sCmd) throws RWESmarthomeSessionExpiredException {
        ...
        try {
            ...
            if (sessionId == null || "".equals(sessionId)) {
                throw new LoginFailedException(String.format(
                        "LoginFailed: Authentication with user '%s' was not possible. Session ID is empty.", username));
            }
