...
public class DigitalSTROMJSONImpl implements DigitalSTROMAPI {
            ...
            if (handler.checkResponse(responseObj)) {
                ...
                if (valueObject != null
                    ...
                    try {
                        ...
                        logger.error("NumberFormatException by getDeviceOutputValue: "
                                + valueObject.get(JSONApiResponseKeysEnum.DEVICE_GET_OUTPUT_VALUE.getKey()).toString());
                    }
                    return value;
                }
            ...
            if (handler.checkResponse(responseObj)) {
                ...
                if (valueObject != null && valueObject
                    ...
                    try {
                        ...
                        logger.error("NumberFormatException by getDeviceSensorValue: " + valueObject
                                .get(JSONApiResponseKeysEnum.DEVICE_GET_SENSOR_VALUE_SENSOR_VALUE.getKey()).toString());
                    }
    ...
    @Override
    public boolean unsubscribeEvent(String token, String name, int subscriptionID, int connectTimeout,
            int readTimeout) {
        if (name != null && !name.trim().equals("") && withParameterSubscriptionID(subscriptionID)) {
            String response = null;
        ...
        if (handler.checkResponse(responseObj)) {
            ...
            if (obj != null && obj.get(JSONApiResponseKeysEnum.SYSTEM_GET_TIME.getKey()) != null) {
                ...
                try {
                    ...
                    logger.error("NumberFormatException by getTime: "
