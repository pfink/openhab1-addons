...
public interface JSONRequestConstants {
    ...
    public final static String INFIX_PARAMETER_FORCE_TRUE = NEXT_PARAMETER_CONCAT_SYMBOL + PARAMETER_FORCE
            + TRUE_TO_STRING;
    ...
    public final static String INFIX_PARAMETER_UNASSIGNED_TRUE = NEXT_PARAMETER_CONCAT_SYMBOL + PARAMETER_UNASSDIGNED
            + TRUE_TO_STRING;
    ...
    public final static String INFIX_PARAMETER_GROUP_COLOR_MODE = NEXT_PARAMETER_CONCAT_SYMBOL
    ...
    public final static String INFIX_PARAMETER_SCENE_DEVICE_MODE = NEXT_PARAMETER_CONCAT_SYMBOL
            + PARAMETER_SCENE_DEVICE_MODE;

    // Apartment
    public final static String JSON_APARTMENT_GET_STRUCTURE = JSON_APARTMENT_PREFIX + GET_STRUCTURE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_APARTMENT_GET_NAME = JSON_APARTMENT_PREFIX + GET_NAME_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_APARTMENT_SET_NAME = JSON_APARTMENT_PREFIX + SET_NAME_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_APARTMENT_TURN_ON = JSON_APARTMENT_PREFIX + TURN_ON_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_APARTMENT_TURN_OFF = JSON_APARTMENT_PREFIX + TURN_OFF_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_APARTMENT_INCREASE_VALUE = JSON_APARTMENT_PREFIX + INCREASE_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_APARTMENT_DECREASE_VALUE = JSON_APARTMENT_PREFIX + DECREASE_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_APARTMENT_SET_VALUE = JSON_APARTMENT_PREFIX + SET_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_APARTMENT_CALLSCENE = JSON_APARTMENT_PREFIX + CALLSCENE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_APARTMENT_SAVESCENE = JSON_APARTMENT_PREFIX + SAVESCENE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_APARTMENT_UNDOSCENE = JSON_APARTMENT_PREFIX + UNDOSCENE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_APARTMENT_GET_CONSUMPTION = JSON_APARTMENT_PREFIX + GET_CONSUMPTION_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_APARTMENT_GET_DEVICES = JSON_APARTMENT_PREFIX + GET_DEVICES_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_APARTMENT_GET_CIRCUITS = JSON_APARTMENT_PREFIX + GET_CIRCUITS_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_APARTMENT_RESCAN = JSON_APARTMENT_PREFIX + RESCAN_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    // Zone
    public final static String JSON_ZONE_GET_NAME = JSON_ZONE_PREFIX + GET_NAME_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_ZONE_SET_NAME = JSON_ZONE_PREFIX + SET_NAME_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_ZONE_TURN_ON = JSON_ZONE_PREFIX + TURN_ON_TO_STRING + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_ZONE_TURN_OFF = JSON_ZONE_PREFIX + TURN_OFF_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_ZONE_INCREASE_VALUE = JSON_ZONE_PREFIX + INCREASE_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_ZONE_DECREASE_VALUE = JSON_ZONE_PREFIX + DECREASE_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;
    ...
    public final static String JSON_ZONE_SET_VALUE = JSON_ZONE_PREFIX + SET_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_ZONE_CALLSCENE = JSON_ZONE_PREFIX + CALLSCENE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_ZONE_SAVESCENE = JSON_ZONE_PREFIX + SAVESCENE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_ZONE_UNDOSCENE = JSON_ZONE_PREFIX + UNDOSCENE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_ZONE_GET_CONSUMPTION = JSON_ZONE_PREFIX + GET_CONSUMPTION_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_ZONE_SCENE_SET_NAME = JSON_ZONE_PREFIX + SCENE_SET_NAME_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_ZONE_SCENE_GET_NAME = JSON_ZONE_PREFIX + SCENE_GET_NAME_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_ZONE_PUSH_SENSOR_VALUES = JSON_ZONE_PREFIX + PUSH_SENSOR_VALUES_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_ZONE_GET_REACHABLE_SCENES = JSON_ZONE_PREFIX + GET_REACHABLE_SCENES_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    // Device
    public final static String JSON_DEVICE_GET_NAME = JSON_DEVICE_PREFIX + GET_NAME_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_SET_NAME = JSON_DEVICE_PREFIX + SET_NAME_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_GET_SPEC = JSON_DEVICE_PREFIX + GET_SPEC_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_GET_GROUPS = JSON_DEVICE_PREFIX + GET_GROUPS_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_TURN_ON = JSON_DEVICE_PREFIX + TURN_ON_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_TURN_OFF = JSON_DEVICE_PREFIX + TURN_OFF_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_INCREASE_VALUE = JSON_DEVICE_PREFIX + INCREASE_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_DECREASE_VALUE = JSON_DEVICE_PREFIX + DECREASE_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_SAVESCENE = JSON_DEVICE_PREFIX + SAVESCENE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_UNDOSCENE = JSON_DEVICE_PREFIX + UNDOSCENE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_GET_CONSUMPTION = JSON_DEVICE_PREFIX + GET_CONSUMPTION_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_ADD_TAG = JSON_DEVICE_PREFIX + ADD_TAG_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_REMOVE_TAG = JSON_DEVICE_PREFIX + REMOVE_TAG_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_HAS_TAG = JSON_DEVICE_PREFIX + HAS_TAG_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_GET_TAGS = JSON_DEVICE_PREFIX + GET_TAGS_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_LOCK = JSON_DEVICE_PREFIX + LOCK_TO_STRING + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_UNLOCK = JSON_DEVICE_PREFIX + UNLOCK_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_GET_SENSOR_EVENT_TABLE_ENTRY = JSON_DEVICE_PREFIX
            + GET_SENSOR_EVENT_TABLE_ENTRY_TO_STRING + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_SET_SENSOR_EVENT_TABLE_ENTRY = JSON_DEVICE_PREFIX
            + SET_SENSOR_EVENT_TABLE_ENTRY_TO_STRING + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_ADD_TO_AREA = JSON_DEVICE_PREFIX + ADD_TO_AREA_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_REMOVE_FROM_AREA = JSON_DEVICE_PREFIX + REMOVE_FROM_AREA_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_ENABLE = JSON_DEVICE_PREFIX + ENABLE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_DISABLE = JSON_DEVICE_PREFIX + DISABLE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_GET_STATE = JSON_DEVICE_PREFIX + GET_STATE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_CALLSCENE = JSON_DEVICE_PREFIX + CALLSCENE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_SET_CONFIG = JSON_DEVICE_PREFIX + SET_CONFIG_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_GET_CONFIG = JSON_DEVICE_PREFIX + GET_CONFIG_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_GET_CONFIG_WORD = JSON_DEVICE_PREFIX + GET_CONFIG_WORD_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_SET_JOKER_GROUP = JSON_DEVICE_PREFIX + SET_JOKER_GROUP_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_BUTTON_ID = JSON_DEVICE_PREFIX + SET_BUTTON_ID_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_BUTTON_INPUT_MODE = JSON_DEVICE_PREFIX + SET_BUTTON_INPUT_MODE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_SET_OUTPUT_MODE = JSON_DEVICE_PREFIX + SET_OUTPUT_MODE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_SET_PROG_MODE = JSON_DEVICE_PREFIX + SET_PROG_MODE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_GET_OUTPUT_VALUE = JSON_DEVICE_PREFIX + GET_OUTPUT_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_SET_OUTPUT_VALUE = JSON_DEVICE_PREFIX + SET_OUTPUT_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_GET_SCENE_MODE = JSON_DEVICE_PREFIX + GET_SCENE_MODE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_SET_SCENE_MODE = JSON_DEVICE_PREFIX + SET_SCENE_MODE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_GET_TRANSITION_TIME = JSON_DEVICE_PREFIX + GET_TRANSITION_TIME_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_SET_TRANSITION_TIME = JSON_DEVICE_PREFIX + SET_TRANSITION_TIME_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_GET_LED_MODE = JSON_DEVICE_PREFIX + GET_LED_MODE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_SET_LED_MODE = JSON_DEVICE_PREFIX + SET_LED_MODE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_GET_SENSOR_VALUE = JSON_DEVICE_PREFIX + GET_SENSOR_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_GET_SENSOR_TYPE = JSON_DEVICE_PREFIX + GET_SENSOR_TYPE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_DEVICE_SET_VALUE = JSON_DEVICE_PREFIX + SET_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    // Circuit
    public final static String JSON_CIRCUIT_GET_NAME = JSON_CIRCUIT_PREFIX + GET_NAME_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_CIRCUIT_SET_NAME = JSON_CIRCUIT_PREFIX + SET_NAME_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_CIRCUIT_GET_CONSUMPTION = JSON_CIRCUIT_PREFIX + GET_CONSUMPTION_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_CIRCUIT_GET_ENERGY_METER_VALUE = JSON_CIRCUIT_PREFIX
            + GET_ENERGY_METER_VALUE_TO_STRING + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_CIRCUIT_RESCAN = JSON_CIRCUIT_PREFIX + RESCAN_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    // Property
    public final static String JSON_PROPERTY_GET_STRING = JSON_PROPERTY_PREFIX + GET_STRING_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_PROPERTY_GET_INTEGER = JSON_PROPERTY_PREFIX + GET_INTEGER_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_PROPERTY_GET_BOOLEAN = JSON_PROPERTY_PREFIX + GET_BOOLEAN_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_PROPERTY_SET_STRING = JSON_PROPERTY_PREFIX + SET_STRING_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_PROPERTY_SET_INTEGER = JSON_PROPERTY_PREFIX + SET_INTEGER_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_PROPERTY_SET_BOOLEAN = JSON_PROPERTY_PREFIX + SET_BOOLEAN_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_PROPERTY_GET_CHILDREN = JSON_PROPERTY_PREFIX + GET_CHILDREN_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_PROPERTY_GET_TYPE = JSON_PROPERTY_PREFIX + GET_TYPE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_PROPERTY_SET_FLAG = JSON_PROPERTY_PREFIX + SET_FLAG_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_PROPERTY_GET_FLAGS = JSON_PROPERTY_PREFIX + GET_FLAGS_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_PROPERTY_QUERY = JSON_PROPERTY_PREFIX + QUERY_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_PROPERTY_REMOVE = JSON_PROPERTY_PREFIX + REMOVE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    // Event
    public final static String JSON_EVENT_RAISE = JSON_EVENT_PREFIX + RAISE_TO_STRING + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_EVENT_SUBSCRIBE = JSON_EVENT_PREFIX + SUBSCRIBE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_EVENT_UNSUBSCRIBE = JSON_EVENT_PREFIX + UNSUBSCRIBE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_EVENT_GET = JSON_EVENT_PREFIX + GET_TO_STRING + FIRST_PARAMETER_CONCAT_SYMBOL;

    // System
    public final static String JSON_SYSTEM_VERSION = JSON_SYSTEM_PREFIX + VERSION_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;
    ...
    public final static String JSON_SYSTEM_LOGIN_APPLICATION = JSON_SYSTEM_PREFIX + LOGIN_APPLICATION_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL + LOGIN_TOKEN_TO_STRING + EQUAL_SIGN_SYMBOL;

    public final static String JSON_SYSTEM_LOGOUT = JSON_SYSTEM_PREFIX + LOGOUT_TO_STRING;

    public final static String JSON_SYSTEM_LOGGED_IN_USER = JSON_SYSTEM_PREFIX + LOGGED_IN_USER_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    // Set
    public final static String JSON_SET_FROM_APARTMENT = JSON_SET_PREFIX + FROM_APARTMENT_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;
    ...
    public final static String JSON_SET_INCREASE_VALUE = JSON_SET_PREFIX + INCREASE_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_SET_DECREASE_VALUE = JSON_SET_PREFIX + DECREASE_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;
    ...
    public final static String JSON_SET_SET_VALUE = JSON_SET_PREFIX + SET_VALUE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_SET_CALLSCENE = JSON_SET_PREFIX + CALLSCENE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_SET_SAVESCENE = JSON_SET_PREFIX + SAVESCENE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_SET_UNDOSCENE = JSON_SET_PREFIX + UNDOSCENE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_SET_GET_CONSUMPTION = JSON_SET_PREFIX + GET_CONSUMPTION_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    // Structure
    public final static String JSON_STRUCTURE_ZONE_ADD_DEVICE = JSON_STRUCTURE_PREFIX + ZONE_ADD_DEVICE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_STRUCTURE_ADD_ZONE = JSON_STRUCTURE_PREFIX + ADD_ZONE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_STRUCTURE_REMOVE_ZONE = JSON_STRUCTURE_PREFIX + REMOVE_ZONE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_STRUCTURE_REMOVE_DEVICE = JSON_STRUCTURE_PREFIX + REMOVE_DEVICE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_STRUCTURE_PERSIST_SET = JSON_STRUCTURE_PREFIX + PERSIST_SET_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_STRUCTURE_UNPERSIST_SET = JSON_STRUCTURE_PREFIX + UNPERSIST_SET_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_STRUCTURE_ADD_GROUP = JSON_STRUCTURE_PREFIX + ADD_GROUP_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_STRUCTURE_GROUP_ADD_DEVICE = JSON_STRUCTURE_PREFIX + GROUP_ADD_DEVICE_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_STRUCTURE_GROUP_REMOVE_DEVICE = JSON_STRUCTURE_PREFIX
            + GROUP_REMOVE_DEVICE_TO_STRING + FIRST_PARAMETER_CONCAT_SYMBOL;

    // Metering
    public final static String JSON_METERING_GET_RESOLUTIONS = JSON_METERING_PREFIX + GET_RESOLUTIONS_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_METERING_GET_SERIES = JSON_METERING_PREFIX + GET_SERIES_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_METERING_GET_VALUES = JSON_METERING_PREFIX + GET_VALUES_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    public final static String JSON_METERING_GET_LATEST = JSON_METERING_PREFIX + GET_LATEST_TO_STRING
            + FIRST_PARAMETER_CONCAT_SYMBOL;

    // Token
    public final static String JSON_TOKEN_AT_LAST_PREFIX = NEXT_PARAMETER_CONCAT_SYMBOL + TOKEN_TO_STRING
            + EQUAL_SIGN_SYMBOL;

    public final static String JSON_TOKEN_AT_FIRST = FIRST_PARAMETER_CONCAT_SYMBOL + TOKEN_TO_STRING
            + EQUAL_SIGN_SYMBOL;
