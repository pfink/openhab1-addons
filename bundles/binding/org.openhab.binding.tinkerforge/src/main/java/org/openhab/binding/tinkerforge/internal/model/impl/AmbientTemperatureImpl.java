 ...
 *        </p>
 *        <ul>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.AmbientTemperatureImpl#getSensorValue
...
public class AmbientTemperatureImpl extends MinimalEObjectImpl.Container implements AmbientTemperature {
    ...
    public void setSensorValue(DecimalValue newSensorValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AMBIENT_TEMPERATURE__SENSOR_VALUE,
    ...
    public void setLogger(Logger newLogger) {
        ...
        logger = newLogger;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AMBIENT_TEMPERATURE__LOGGER, oldLogger,
                    logger));
    }
    ...
    public void setPoll(boolean newPoll) {
        ...
        poll = newPoll;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AMBIENT_TEMPERATURE__POLL, oldPoll,
                    poll));
    }
    ...
    public void setEnabledA(AtomicBoolean newEnabledA) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AMBIENT_TEMPERATURE__ENABLED_A,
    ...
    public void setSubId(String newSubId) {
        ...
        subId = newSubId;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AMBIENT_TEMPERATURE__SUB_ID, oldSubId,
                    subId));
    }
    ...
    public MBrickletTemperatureIR getMbrick() {
        if (eContainerFeatureID() != ModelPackage.AMBIENT_TEMPERATURE__MBRICK)
            return null;
    ...
    public void setMbrick(MBrickletTemperatureIR newMbrick) {
        if (newMbrick != eInternalContainer()
                || (eContainerFeatureID() != ModelPackage.AMBIENT_TEMPERATURE__MBRICK && newMbrick != null)) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AMBIENT_TEMPERATURE__MBRICK, newMbrick,
                    newMbrick));
    }
    ...
    public void setCallbackPeriod(long newCallbackPeriod) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AMBIENT_TEMPERATURE__CALLBACK_PERIOD,
    ...
    public void setThreshold(BigDecimal newThreshold) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AMBIENT_TEMPERATURE__THRESHOLD,
    ...
    public NotificationChain basicSetTfConfig(TFBaseConfiguration newTfConfig, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ModelPackage.AMBIENT_TEMPERATURE__TF_CONFIG, oldTfConfig, newTfConfig);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newTfConfig != tfConfig) {
            ...
            if (tfConfig != null)
                msgs = ((InternalEObject) tfConfig).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ModelPackage.AMBIENT_TEMPERATURE__TF_CONFIG, null, msgs);
            if (newTfConfig != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AMBIENT_TEMPERATURE__TF_CONFIG,
    ...
    public void enable() {
        ...
        tinkerforgeDevice.setResponseExpected(BrickletTemperatureIR.FUNCTION_SET_AMBIENT_TEMPERATURE_CALLBACK_PERIOD,
                false);
        try {
     ...
     * @generated NOT
     */
    private class AmbientTemperatureListener implements BrickletTemperatureIR.AmbientTemperatureListener {
        ...
        if (baseClass == MBaseDevice.class) {
            switch (baseOperationID) {
                case ModelPackage.MBASE_DEVICE___INIT:
                    return ModelPackage.AMBIENT_TEMPERATURE___INIT;
                case ModelPackage.MBASE_DEVICE___ENABLE:
                    return ModelPackage.AMBIENT_TEMPERATURE___ENABLE;
                case ModelPackage.MBASE_DEVICE___DISABLE:
                    return ModelPackage.AMBIENT_TEMPERATURE___DISABLE;
                default:
                    return -1;
            }
        }
