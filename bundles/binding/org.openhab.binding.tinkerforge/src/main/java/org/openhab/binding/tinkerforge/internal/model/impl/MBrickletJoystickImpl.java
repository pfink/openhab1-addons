...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MBricklet Joystick</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletJoystickImpl#isPoll <em>Poll</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletJoystickImpl#getEnabledA <em>Enabled A</em>}
 * </li>
 ...
 * @generated
 */
public class MBrickletJoystickImpl extends MinimalEObjectImpl.Container implements MBrickletJoystick {
    /**
     ...
     * @ordered
     */
    protected BrickletJoystick tinkerforgeDevice;
     ...
     * @ordered
     */
    protected EList<JoystickDevice> msubdevices;
     ...
     * @ordered
     */
    protected static final String DEVICE_TYPE_EDEFAULT = "bricklet_joystick";
     ...
     * @generated
     */
    protected MBrickletJoystickImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return ModelPackage.Literals.MBRICKLET_JOYSTICK;
    }
     ...
     */
    @Override
    public BrickletJoystick getTinkerforgeDevice() {
    ...
    public NotificationChain basicSetBrickd(MBrickd newBrickd, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newBrickd, ModelPackage.MBRICKLET_JOYSTICK__BRICKD, msgs);
        return msgs;
    }
    ...
    public void init() {
        ...
        logger = LoggerFactory.getLogger(MBrickletJoystickImpl.class);
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ModelPackage.MBRICKLET_JOYSTICK__LOGGER:
                return getLogger();
            case ModelPackage.MBRICKLET_JOYSTICK__UID:
                return getUid();
            case ModelPackage.MBRICKLET_JOYSTICK__POLL:
                return isPoll();
            case ModelPackage.MBRICKLET_JOYSTICK__ENABLED_A:
                return getEnabledA();
            case ModelPackage.MBRICKLET_JOYSTICK__TINKERFORGE_DEVICE:
                return getTinkerforgeDevice();
            case ModelPackage.MBRICKLET_JOYSTICK__IP_CONNECTION:
                return getIpConnection();
            case ModelPackage.MBRICKLET_JOYSTICK__CONNECTED_UID:
                return getConnectedUid();
            case ModelPackage.MBRICKLET_JOYSTICK__POSITION:
                return getPosition();
            case ModelPackage.MBRICKLET_JOYSTICK__DEVICE_IDENTIFIER:
            ...
            case ModelPackage.MBRICKLET_JOYSTICK__TF_CONFIG:
                return getTfConfig();
            case ModelPackage.MBRICKLET_JOYSTICK__DEVICE_TYPE:
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case ModelPackage.MBRICKLET_JOYSTICK__ENABLED_A:
                ...
                return;
            case ModelPackage.MBRICKLET_JOYSTICK__TINKERFORGE_DEVICE:
                setTinkerforgeDevice((BrickletJoystick) newValue);
                return;
            case ModelPackage.MBRICKLET_JOYSTICK__IP_CONNECTION:
            ...
            case ModelPackage.MBRICKLET_JOYSTICK__MSUBDEVICES:
                ...
                getMsubdevices().addAll((Collection<? extends JoystickDevice>) newValue);
                return;
            case ModelPackage.MBRICKLET_JOYSTICK__CALLBACK_PERIOD:
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.MBRICKLET_JOYSTICK__ENABLED_A:
                ...
                return;
            case ModelPackage.MBRICKLET_JOYSTICK__TINKERFORGE_DEVICE:
                setTinkerforgeDevice((BrickletJoystick) null);
                return;
            case ModelPackage.MBRICKLET_JOYSTICK__IP_CONNECTION:
        ...
        if (baseClass == MSubDeviceHolder.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSUB_DEVICE_HOLDER__MSUBDEVICES:
                    return ModelPackage.MBRICKLET_JOYSTICK__MSUBDEVICES;
                default:
                    return -1;
            }
        }
        if (baseClass == CallbackListener.class) {
            switch (baseFeatureID) {
                case ModelPackage.CALLBACK_LISTENER__CALLBACK_PERIOD:
                    return ModelPackage.MBRICKLET_JOYSTICK__CALLBACK_PERIOD;
                default:
                    return -1;
            }
        }
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.MBRICKLET_JOYSTICK__TF_CONFIG;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSubDeviceHolder.class) {
            switch (baseOperationID) {
                case ModelPackage.MSUB_DEVICE_HOLDER___INIT_SUB_DEVICES:
                    return ModelPackage.MBRICKLET_JOYSTICK___INIT_SUB_DEVICES;
                default:
                    return -1;
            }
        }
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            case ModelPackage.MBRICKLET_JOYSTICK___INIT_SUB_DEVICES:
                initSubDevices();
                return null;
            case ModelPackage.MBRICKLET_JOYSTICK___INIT:
                init();
                return null;
            case ModelPackage.MBRICKLET_JOYSTICK___ENABLE:
                enable();
                return null;
            case ModelPackage.MBRICKLET_JOYSTICK___DISABLE:
                disable();
                return null;
        }
