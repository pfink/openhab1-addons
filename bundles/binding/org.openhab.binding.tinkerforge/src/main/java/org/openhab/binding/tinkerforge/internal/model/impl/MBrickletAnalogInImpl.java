...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MBricklet Analog In</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class MBrickletAnalogInImpl extends MinimalEObjectImpl.Container implements MBrickletAnalogIn {
    /**
     ...
     * @ordered
     */
    protected BrickletAnalogIn tinkerforgeDevice;
     ...
     * @ordered
     */
    protected TFAnalogInConfiguration tfConfig;
     ...
     * @ordered
     */
    protected static final String DEVICE_TYPE_EDEFAULT = "bricklet_analogin";
     ...
     * @ordered
     */
    protected static final Short RANGE_EDEFAULT = new Short((short) 0);
     ...
     * @generated
     */
    protected MBrickletAnalogInImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return ModelPackage.Literals.MBRICKLET_ANALOG_IN;
    }
    ...
    public void setLogger(Logger newLogger) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__LOGGER, oldLogger,
                    logger));
    }
    ...
    public void setUid(String newUid) {
        ...
        uid = newUid;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__UID, oldUid, uid));
    }
    ...
    public void setPoll(boolean newPoll) {
        ...
        poll = newPoll;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__POLL, oldPoll,
                    poll));
    }
    ...
    public void setEnabledA(AtomicBoolean newEnabledA) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__ENABLED_A,
     ...
     */
    @Override
    public BrickletAnalogIn getTinkerforgeDevice() {
     ...
     */
    @Override
    public void setTinkerforgeDevice(BrickletAnalogIn newTinkerforgeDevice) {
        BrickletAnalogIn oldTinkerforgeDevice = tinkerforgeDevice;
        tinkerforgeDevice = newTinkerforgeDevice;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__TINKERFORGE_DEVICE,
    ...
    public void setIpConnection(IPConnection newIpConnection) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__IP_CONNECTION,
    ...
    public void setConnectedUid(String newConnectedUid) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__CONNECTED_UID,
    ...
    public void setPosition(char newPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__POSITION,
    ...
    public void setDeviceIdentifier(int newDeviceIdentifier) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__DEVICE_IDENTIFIER,
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__NAME, oldName,
                    name));
    }
    ...
    public MBrickd getBrickd() {
        if (eContainerFeatureID() != ModelPackage.MBRICKLET_ANALOG_IN__BRICKD)
            return null;
    ...
    public NotificationChain basicSetBrickd(MBrickd newBrickd, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newBrickd, ModelPackage.MBRICKLET_ANALOG_IN__BRICKD, msgs);
        return msgs;
    }
    ...
    public void setBrickd(MBrickd newBrickd) {
        if (newBrickd != eInternalContainer()
                || (eContainerFeatureID() != ModelPackage.MBRICKLET_ANALOG_IN__BRICKD && newBrickd != null)) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__BRICKD, newBrickd,
                    newBrickd));
    }
    ...
    public void setSensorValue(DecimalValue newSensorValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__SENSOR_VALUE,
     ...
     */
    @Override
    public TFAnalogInConfiguration getTfConfig() {
        return tfConfig;
    }
     ...
     * @generated
     */
    public NotificationChain basicSetTfConfig(TFAnalogInConfiguration newTfConfig, NotificationChain msgs) {
        TFAnalogInConfiguration oldTfConfig = tfConfig;
        tfConfig = newTfConfig;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ModelPackage.MBRICKLET_ANALOG_IN__TF_CONFIG, oldTfConfig, newTfConfig);
            if (msgs == null)
                msgs = notification;
            else
     ...
     */
    @Override
    public void setTfConfig(TFAnalogInConfiguration newTfConfig) {
        if (newTfConfig != tfConfig) {
            NotificationChain msgs = null;
            if (tfConfig != null)
                msgs = ((InternalEObject) tfConfig).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ModelPackage.MBRICKLET_ANALOG_IN__TF_CONFIG, null, msgs);
            if (newTfConfig != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__TF_CONFIG,
    ...
    public void setCallbackPeriod(long newCallbackPeriod) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__CALLBACK_PERIOD,
    ...
    public void setThreshold(BigDecimal newThreshold) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__THRESHOLD,
    ...
    public void setMovingAverage(Short newMovingAverage) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__MOVING_AVERAGE,
    ...
    public void setRange(Short newRange) {
        ...
        range = newRange;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ANALOG_IN__RANGE, oldRange,
                    range));
    }
    ...
    public void init() {
        ...
        logger = LoggerFactory.getLogger(MBrickletAnalogInV2Impl.class);
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case ModelPackage.MBRICKLET_ANALOG_IN__BRICKD:
                if (eInternalContainer() != null)
                    msgs = eBasicRemoveFromContainer(msgs);
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case ModelPackage.MBRICKLET_ANALOG_IN__TF_CONFIG:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ModelPackage.MBRICKLET_ANALOG_IN__LOGGER:
                return getLogger();
            case ModelPackage.MBRICKLET_ANALOG_IN__UID:
                return getUid();
            case ModelPackage.MBRICKLET_ANALOG_IN__POLL:
                return isPoll();
            case ModelPackage.MBRICKLET_ANALOG_IN__ENABLED_A:
                return getEnabledA();
            case ModelPackage.MBRICKLET_ANALOG_IN__TINKERFORGE_DEVICE:
                return getTinkerforgeDevice();
            case ModelPackage.MBRICKLET_ANALOG_IN__IP_CONNECTION:
                return getIpConnection();
            case ModelPackage.MBRICKLET_ANALOG_IN__CONNECTED_UID:
                return getConnectedUid();
            case ModelPackage.MBRICKLET_ANALOG_IN__POSITION:
                return getPosition();
            case ModelPackage.MBRICKLET_ANALOG_IN__DEVICE_IDENTIFIER:
                return getDeviceIdentifier();
            case ModelPackage.MBRICKLET_ANALOG_IN__NAME:
                return getName();
            case ModelPackage.MBRICKLET_ANALOG_IN__BRICKD:
                if (resolve)
                    return getBrickd();
                return basicGetBrickd();
            case ModelPackage.MBRICKLET_ANALOG_IN__SENSOR_VALUE:
                return getSensorValue();
            case ModelPackage.MBRICKLET_ANALOG_IN__TF_CONFIG:
                return getTfConfig();
            case ModelPackage.MBRICKLET_ANALOG_IN__CALLBACK_PERIOD:
                return getCallbackPeriod();
            case ModelPackage.MBRICKLET_ANALOG_IN__DEVICE_TYPE:
                return getDeviceType();
            case ModelPackage.MBRICKLET_ANALOG_IN__THRESHOLD:
                return getThreshold();
            case ModelPackage.MBRICKLET_ANALOG_IN__MOVING_AVERAGE:
                return getMovingAverage();
            case ModelPackage.MBRICKLET_ANALOG_IN__RANGE:
                return getRange();
        }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case ModelPackage.MBRICKLET_ANALOG_IN__ENABLED_A:
                ...
                return;
            case ModelPackage.MBRICKLET_ANALOG_IN__TINKERFORGE_DEVICE:
                setTinkerforgeDevice((BrickletAnalogIn) newValue);
                return;
            case ModelPackage.MBRICKLET_ANALOG_IN__IP_CONNECTION:
            ...
            case ModelPackage.MBRICKLET_ANALOG_IN__SENSOR_VALUE:
                ...
                return;
            case ModelPackage.MBRICKLET_ANALOG_IN__TF_CONFIG:
                setTfConfig((TFAnalogInConfiguration) newValue);
                return;
            case ModelPackage.MBRICKLET_ANALOG_IN__CALLBACK_PERIOD:
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.MBRICKLET_ANALOG_IN__ENABLED_A:
                ...
                return;
            case ModelPackage.MBRICKLET_ANALOG_IN__TINKERFORGE_DEVICE:
                setTinkerforgeDevice((BrickletAnalogIn) null);
                return;
            case ModelPackage.MBRICKLET_ANALOG_IN__IP_CONNECTION:
            ...
            case ModelPackage.MBRICKLET_ANALOG_IN__SENSOR_VALUE:
                ...
                return;
            case ModelPackage.MBRICKLET_ANALOG_IN__TF_CONFIG:
                setTfConfig((TFAnalogInConfiguration) null);
                return;
            case ModelPackage.MBRICKLET_ANALOG_IN__CALLBACK_PERIOD:
        ...
        if (baseClass == MSensor.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSENSOR__SENSOR_VALUE:
                    return ModelPackage.MBRICKLET_ANALOG_IN__SENSOR_VALUE;
                default:
                    return -1;
            }
        }
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.MBRICKLET_ANALOG_IN__TF_CONFIG;
                default:
                    return -1;
            }
        }
        if (baseClass == CallbackListener.class) {
            switch (baseFeatureID) {
                case ModelPackage.CALLBACK_LISTENER__CALLBACK_PERIOD:
                    return ModelPackage.MBRICKLET_ANALOG_IN__CALLBACK_PERIOD;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSensor.class) {
            switch (baseOperationID) {
                case ModelPackage.MSENSOR___FETCH_SENSOR_VALUE:
                    return ModelPackage.MBRICKLET_ANALOG_IN___FETCH_SENSOR_VALUE;
                default:
                    return -1;
            }
        }
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            case ModelPackage.MBRICKLET_ANALOG_IN___FETCH_SENSOR_VALUE:
                fetchSensorValue();
                return null;
            case ModelPackage.MBRICKLET_ANALOG_IN___INIT:
                init();
                return null;
            case ModelPackage.MBRICKLET_ANALOG_IN___ENABLE:
                enable();
                return null;
            case ModelPackage.MBRICKLET_ANALOG_IN___DISABLE:
                disable();
                return null;
        }
