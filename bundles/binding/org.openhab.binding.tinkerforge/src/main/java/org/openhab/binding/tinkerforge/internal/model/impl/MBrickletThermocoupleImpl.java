 ...
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletThermocoupleImpl#getEnabledA <em>Enabled
 * A</em>}</li>
 ...
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletThermocoupleImpl#getIpConnection <em>Ip
 * Connection</em>}</li>
 ...
 * </li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletThermocoupleImpl#getSensorValue <em>Sensor
 * Value</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletThermocoupleImpl#getTfConfig <em>Tf
 * Config</em>}</li>
 ...
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletThermocoupleImpl#getDeviceType <em>Device
 * Type</em>}</li>
...
public class MBrickletThermocoupleImpl extends MinimalEObjectImpl.Container implements MBrickletThermocouple {
    ...
    private class TemperatureListener implements BrickletThermocouple.TemperatureListener {
        ...
        public void temperature(int newTemperature) {
            DecimalValue newValue = Tools.calculate100(newTemperature);
