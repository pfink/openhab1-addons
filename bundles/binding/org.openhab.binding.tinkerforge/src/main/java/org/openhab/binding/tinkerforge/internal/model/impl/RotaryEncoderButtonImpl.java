...
public class RotaryEncoderButtonImpl extends MinimalEObjectImpl.Container implements RotaryEncoderButton {
    ...
    private class ButtonListener
            implements BrickletRotaryEncoder.PressedListener, BrickletRotaryEncoder.ReleasedListener {
        ...
        if (baseClass == MSensor.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSENSOR__SENSOR_VALUE:
                    return ModelPackage.ROTARY_ENCODER_BUTTON__SENSOR_VALUE;
                default:
                    return -1;
            }
        }
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.ROTARY_ENCODER_BUTTON__TF_CONFIG;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSensor.class) {
            switch (baseOperationID) {
                case ModelPackage.MSENSOR___FETCH_SENSOR_VALUE:
                    return ModelPackage.ROTARY_ENCODER_BUTTON___FETCH_SENSOR_VALUE;
                default:
                    return -1;
            }
        }
