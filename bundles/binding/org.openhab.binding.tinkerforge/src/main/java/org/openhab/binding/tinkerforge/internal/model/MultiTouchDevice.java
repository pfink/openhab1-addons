...
public interface MultiTouchDevice extends MSubDevice<MBrickletMultiTouch>, MSensor<HighLowValue>,
        MTFConfigConsumer<MultiTouchDeviceConfiguration> {
    ...
    /**
     * Sets the value of the '{@link org.openhab.binding.tinkerforge.internal.model.MultiTouchDevice#getDisableElectrode
