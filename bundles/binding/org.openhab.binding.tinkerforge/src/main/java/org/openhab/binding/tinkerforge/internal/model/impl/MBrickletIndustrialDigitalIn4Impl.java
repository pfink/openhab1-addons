 ...
 *        <em>Logger</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletIndustrialDigitalIn4Impl#getUid
 *        <em>Uid</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletIndustrialDigitalIn4Impl#isPoll
 *        <em>Poll</em>}</li>
 ...
 *        <em>Tf Config</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletIndustrialDigitalIn4Impl#getDeviceType
 *        <em>Device Type</em>}</li>
 *        </ul>
 *
 * @generated
 */
public class MBrickletIndustrialDigitalIn4Impl extends MinimalEObjectImpl.Container
        implements MBrickletIndustrialDigitalIn4 {
    /**
    ...
    public EList<MIndustrialDigitalIn> getMsubdevices() {
        if (msubdevices == null) {
            msubdevices = new EObjectContainmentWithInverseEList<MIndustrialDigitalIn>(MIndustrialDigitalIn.class, this,
                    ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__MSUBDEVICES, ModelPackage.MSUB_DEVICE__MBRICK) {
    ...
    public void setLogger(Logger newLogger) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__LOGGER,
                    oldLogger, logger));
    }
    ...
    public void setUid(String newUid) {
        ...
        uid = newUid;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__UID,
                    oldUid, uid));
    }
    ...
    public void setPoll(boolean newPoll) {
        ...
        poll = newPoll;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__POLL,
                    oldPoll, poll));
    }
    ...
    public void setEnabledA(AtomicBoolean newEnabledA) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__ENABLED_A, oldEnabledA, enabledA));
    }
    ...
    public void setTinkerforgeDevice(BrickletIndustrialDigitalIn4 newTinkerforgeDevice) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__TINKERFORGE_DEVICE, oldTinkerforgeDevice,
                    tinkerforgeDevice));
    }
    ...
    public void setIpConnection(IPConnection newIpConnection) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__IP_CONNECTION, oldIpConnection, ipConnection));
    }
    ...
    public void setConnectedUid(String newConnectedUid) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__CONNECTED_UID, oldConnectedUid, connectedUid));
    }
    ...
    public void setPosition(char newPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__POSITION, oldPosition, position));
    }
    ...
    public void setDeviceIdentifier(int newDeviceIdentifier) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__DEVICE_IDENTIFIER, oldDeviceIdentifier,
                    deviceIdentifier));
    }
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__NAME,
                    oldName, name));
    }
    ...
    public MBrickd getBrickd() {
        if (eContainerFeatureID() != ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__BRICKD)
            return null;
    ...
    public NotificationChain basicSetBrickd(MBrickd newBrickd, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newBrickd, ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__BRICKD,
                msgs);
        return msgs;
    }
    ...
    public void setBrickd(MBrickd newBrickd) {
        if (newBrickd != eInternalContainer()
                || (eContainerFeatureID() != ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__BRICKD
                        && newBrickd != null)) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__BRICKD,
                    newBrickd, newBrickd));
    }
    ...
    public void setDebouncePeriod(long newDebouncePeriod) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__DEBOUNCE_PERIOD, oldDebouncePeriod, debouncePeriod));
    }
    ...
    public NotificationChain basicSetTfConfig(TFInterruptListenerConfiguration newTfConfig, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__TF_CONFIG, oldTfConfig, newTfConfig);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newTfConfig != tfConfig) {
            ...
            if (tfConfig != null)
                msgs = ((InternalEObject) tfConfig).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__TF_CONFIG, null, msgs);
            if (newTfConfig != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__TF_CONFIG, newTfConfig, newTfConfig));
    }
        ...
        if (baseClass == MBaseDevice.class) {
            switch (baseFeatureID) {
                case ModelPackage.MBASE_DEVICE__LOGGER:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__LOGGER;
                case ModelPackage.MBASE_DEVICE__UID:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__UID;
                case ModelPackage.MBASE_DEVICE__POLL:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__POLL;
                case ModelPackage.MBASE_DEVICE__ENABLED_A:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__ENABLED_A;
                default:
                    return -1;
            }
        }
        if (baseClass == MDevice.class) {
            switch (baseFeatureID) {
                case ModelPackage.MDEVICE__TINKERFORGE_DEVICE:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__TINKERFORGE_DEVICE;
                case ModelPackage.MDEVICE__IP_CONNECTION:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__IP_CONNECTION;
                case ModelPackage.MDEVICE__CONNECTED_UID:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__CONNECTED_UID;
                case ModelPackage.MDEVICE__POSITION:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__POSITION;
                case ModelPackage.MDEVICE__DEVICE_IDENTIFIER:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__DEVICE_IDENTIFIER;
                case ModelPackage.MDEVICE__NAME:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__NAME;
                case ModelPackage.MDEVICE__BRICKD:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__BRICKD;
                default:
                    return -1;
            }
        }
        if (baseClass == InterruptListener.class) {
            switch (baseFeatureID) {
                case ModelPackage.INTERRUPT_LISTENER__DEBOUNCE_PERIOD:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__DEBOUNCE_PERIOD;
                default:
                    return -1;
            }
        }
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4__TF_CONFIG;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MBaseDevice.class) {
            switch (baseOperationID) {
                case ModelPackage.MBASE_DEVICE___INIT:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4___INIT;
                case ModelPackage.MBASE_DEVICE___ENABLE:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4___ENABLE;
                case ModelPackage.MBASE_DEVICE___DISABLE:
                    return ModelPackage.MBRICKLET_INDUSTRIAL_DIGITAL_IN4___DISABLE;
                default:
                    return -1;
            }
        }
