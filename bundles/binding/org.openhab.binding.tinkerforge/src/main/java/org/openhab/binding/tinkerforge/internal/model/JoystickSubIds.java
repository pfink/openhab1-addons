...
public enum JoystickSubIds implements Enumerator {
     ...
     * @generated
     */
    private static final JoystickSubIds[] VALUES_ARRAY = new JoystickSubIds[] { JOYSTICK_XPOSITION, JOYSTICK_YPOSITION,
            JOYSTICK_BUTTON, };
    ...
    public static JoystickSubIds get(int value) {
        switch (value) {
            case JOYSTICK_XPOSITION_VALUE:
                return JOYSTICK_XPOSITION;
        }
        return null;
    }
