 ...
 * @generated
 */
public class MBrickletLCD20x4Impl extends MinimalEObjectImpl.Container implements MBrickletLCD20x4 {
    /**
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.MBRICKLET_LCD2_0X4__POSITON_SUFFIX:
                return POSITON_SUFFIX_EDEFAULT == null ? positonSuffix != null
                        : !POSITON_SUFFIX_EDEFAULT.equals(positonSuffix);
            case ModelPackage.MBRICKLET_LCD2_0X4__DISPLAY_ERRORS:
        ...
        if (baseClass == MTextActor.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTEXT_ACTOR__TEXT:
                    return ModelPackage.MBRICKLET_LCD2_0X4__TEXT;
                default:
                    return -1;
            }
        }
        if (baseClass == MSubDeviceHolder.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSUB_DEVICE_HOLDER__MSUBDEVICES:
                    return ModelPackage.MBRICKLET_LCD2_0X4__MSUBDEVICES;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSubDeviceHolder.class) {
            switch (baseOperationID) {
                case ModelPackage.MSUB_DEVICE_HOLDER___INIT_SUB_DEVICES:
                    return ModelPackage.MBRICKLET_LCD2_0X4___INIT_SUB_DEVICES;
                default:
                    return -1;
            }
        }
