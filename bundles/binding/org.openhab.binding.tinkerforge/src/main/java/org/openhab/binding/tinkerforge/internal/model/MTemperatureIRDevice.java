...
public interface MTemperatureIRDevice
        extends MSensor<DecimalValue>, MSubDevice<MBrickletTemperatureIR>, CallbackListener {
    /**
    ...
    /**
     * Sets the value of the '{@link org.openhab.binding.tinkerforge.internal.model.MTemperatureIRDevice#getThreshold
