...
public interface MBrickletVoltageCurrent extends MDevice<BrickletVoltageCurrent>,
        MSubDeviceHolder<VoltageCurrentDevice>, MTFConfigConsumer<TFVoltageCurrentConfiguration> {
    /**
    ...
    /**
     * Sets the value of the '{@link org.openhab.binding.tinkerforge.internal.model.MBrickletVoltageCurrent#getAveraging
