...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>IO4 Sub Ids</b></em>',
 * and utility methods for working with them.
 *
 * @author Theo Weiss
 * @since 1.5.0
 *        <!-- end-user-doc -->
 * @see org.openhab.binding.tinkerforge.internal.model.ModelPackage#getIO4SubIds()
 * @model
 * @generated
 */
public enum IO4SubIds implements Enumerator {
    /**
    ...
    /**
     * An array of all the '<em><b>IO4 Sub Ids</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
     */
    private static final IO4SubIds[] VALUES_ARRAY = new IO4SubIds[] { IN0, IN1, IN2, IN3, OUT0, OUT1, OUT2, OUT3, };

    /**
     * A public read-only list of all the '<em><b>IO4 Sub Ids</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
     */
    public static final List<IO4SubIds> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

    /**
     * Returns the '<em><b>IO4 Sub Ids</b></em>' literal with the specified literal value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     ...
     * @generated
     */
    public static IO4SubIds get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            IO4SubIds result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>IO4 Sub Ids</b></em>' literal with the specified name.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @param name the name.
     ...
     * @generated
     */
    public static IO4SubIds getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            IO4SubIds result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>IO4 Sub Ids</b></em>' literal with the specified integer value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     ...
     * @generated
     */
    public static IO4SubIds get(int value) {
        switch (value) {
            case IN0_VALUE:
                return IN0;
        }
     ...
     * @generated
     */
    private IO4SubIds(int value, String name, String literal) {
        this.value = value;
        this.name = name;
