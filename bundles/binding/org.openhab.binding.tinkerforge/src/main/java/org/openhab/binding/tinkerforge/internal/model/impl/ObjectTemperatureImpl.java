...
public class ObjectTemperatureImpl extends MinimalEObjectImpl.Container implements ObjectTemperature {
    ...
    public void enable() {
        ...
        tinkerforgeDevice.setResponseExpected(BrickletTemperatureIR.FUNCTION_SET_OBJECT_TEMPERATURE_CALLBACK_PERIOD,
                false);
        try {
     ...
     * @generated NOT
     */
    private class ObjectTemperatureListener implements BrickletTemperatureIR.ObjectTemperatureListener {
        ...
        if (baseClass == MBaseDevice.class) {
            switch (baseOperationID) {
                case ModelPackage.MBASE_DEVICE___INIT:
                    return ModelPackage.OBJECT_TEMPERATURE___INIT;
                case ModelPackage.MBASE_DEVICE___ENABLE:
                    return ModelPackage.OBJECT_TEMPERATURE___ENABLE;
                case ModelPackage.MBASE_DEVICE___DISABLE:
                    return ModelPackage.OBJECT_TEMPERATURE___DISABLE;
                default:
                    return -1;
            }
        }
