...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MBricklet Moisture</b></em>'.
 *
 * @author Theo Weiss
 * @since 1.5.0
 *        <!-- end-user-doc -->
 ...
 * @generated
 */
public class MBrickletMoistureImpl extends MinimalEObjectImpl.Container implements MBrickletMoisture {
    /**
     ...
     * @ordered
     */
    protected BrickletMoisture tinkerforgeDevice;
     ...
     * @ordered
     */
    protected static final String DEVICE_TYPE_EDEFAULT = "bricklet_moisture";
     ...
     * @generated
     */
    protected MBrickletMoistureImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return ModelPackage.Literals.MBRICKLET_MOISTURE;
    }
     ...
     */
    @Override
    public BrickletMoisture getTinkerforgeDevice() {
    ...
    public NotificationChain basicSetBrickd(MBrickd newBrickd, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newBrickd, ModelPackage.MBRICKLET_MOISTURE__BRICKD, msgs);
        return msgs;
    }
    ...
    public void init() {
        ...
        logger = LoggerFactory.getLogger(MBrickletMoistureImpl.class);
    }
     ...
     * @generated NOT
     */
    private class MoistureListener implements BrickletMoisture.MoistureListener {
    ...
    public void disable() {
        if (listener != null) {
            tinkerforgeDevice.removeMoistureListener(listener);
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ModelPackage.MBRICKLET_MOISTURE__LOGGER:
                return getLogger();
            case ModelPackage.MBRICKLET_MOISTURE__UID:
                return getUid();
            case ModelPackage.MBRICKLET_MOISTURE__POLL:
                return isPoll();
            case ModelPackage.MBRICKLET_MOISTURE__ENABLED_A:
                return getEnabledA();
            case ModelPackage.MBRICKLET_MOISTURE__TINKERFORGE_DEVICE:
                return getTinkerforgeDevice();
            case ModelPackage.MBRICKLET_MOISTURE__IP_CONNECTION:
                return getIpConnection();
            case ModelPackage.MBRICKLET_MOISTURE__CONNECTED_UID:
                return getConnectedUid();
            case ModelPackage.MBRICKLET_MOISTURE__POSITION:
                return getPosition();
            case ModelPackage.MBRICKLET_MOISTURE__DEVICE_IDENTIFIER:
            ...
            case ModelPackage.MBRICKLET_MOISTURE__DEVICE_TYPE:
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case ModelPackage.MBRICKLET_MOISTURE__ENABLED_A:
                ...
                return;
            case ModelPackage.MBRICKLET_MOISTURE__TINKERFORGE_DEVICE:
                setTinkerforgeDevice((BrickletMoisture) newValue);
                return;
            case ModelPackage.MBRICKLET_MOISTURE__IP_CONNECTION:
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.MBRICKLET_MOISTURE__ENABLED_A:
                ...
                return;
            case ModelPackage.MBRICKLET_MOISTURE__TINKERFORGE_DEVICE:
                setTinkerforgeDevice((BrickletMoisture) null);
                return;
            case ModelPackage.MBRICKLET_MOISTURE__IP_CONNECTION:
        ...
        if (baseClass == MSensor.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSENSOR__SENSOR_VALUE:
                    return ModelPackage.MBRICKLET_MOISTURE__SENSOR_VALUE;
                default:
                    return -1;
            }
        }
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.MBRICKLET_MOISTURE__TF_CONFIG;
                default:
                    return -1;
            }
        }
        if (baseClass == CallbackListener.class) {
            switch (baseFeatureID) {
                case ModelPackage.CALLBACK_LISTENER__CALLBACK_PERIOD:
                    return ModelPackage.MBRICKLET_MOISTURE__CALLBACK_PERIOD;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSensor.class) {
            switch (baseOperationID) {
                case ModelPackage.MSENSOR___FETCH_SENSOR_VALUE:
                    return ModelPackage.MBRICKLET_MOISTURE___FETCH_SENSOR_VALUE;
                default:
                    return -1;
            }
        }
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            case ModelPackage.MBRICKLET_MOISTURE___INIT:
                init();
                return null;
            case ModelPackage.MBRICKLET_MOISTURE___FETCH_SENSOR_VALUE:
                fetchSensorValue();
                return null;
            case ModelPackage.MBRICKLET_MOISTURE___ENABLE:
                enable();
                return null;
            case ModelPackage.MBRICKLET_MOISTURE___DISABLE:
                disable();
                return null;
        }
