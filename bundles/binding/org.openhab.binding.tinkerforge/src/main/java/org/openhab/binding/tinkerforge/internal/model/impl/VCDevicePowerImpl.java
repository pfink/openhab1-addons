...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>VC Device Power</b></em>'.
 *
 * @author Theo Weiss
 * @since 1.5.0
 *        <!-- end-user-doc -->
 ...
 * @generated
 */
public class VCDevicePowerImpl extends MinimalEObjectImpl.Container implements VCDevicePower {
    /**
     ...
     * @ordered
     */
    protected static final String DEVICE_TYPE_EDEFAULT = "voltageCurrent_power";
    ...
    protected EClass eStaticClass() {
        return ModelPackage.Literals.VC_DEVICE_POWER;
    }
    ...
    public NotificationChain basicSetMbrick(MBrickletVoltageCurrent newMbrick, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newMbrick, ModelPackage.VC_DEVICE_POWER__MBRICK, msgs);
        return msgs;
    }
    ...
    public void init() {
        ...
        logger = LoggerFactory.getLogger(VCDevicePowerImpl.class);
    }
    ...
    public void enable() {
        ...
        try {
            ...
            tinkerforgeDevice.setPowerCallbackPeriod(getCallbackPeriod());
            listener = new PowerListener();
            tinkerforgeDevice.addPowerListener(listener);
            fetchSensorValue();
     ...
     * @generated NOT
     */
    private class PowerListener implements BrickletVoltageCurrent.PowerListener {
    ...
    public void disable() {
        if (listener != null) {
            tinkerforgeDevice.removePowerListener(listener);
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ModelPackage.VC_DEVICE_POWER__SENSOR_VALUE:
            ...
            case ModelPackage.VC_DEVICE_POWER__TF_CONFIG:
                return getTfConfig();
            case ModelPackage.VC_DEVICE_POWER__DEVICE_TYPE:
                return getDeviceType();
            case ModelPackage.VC_DEVICE_POWER__THRESHOLD:
                return getThreshold();
        }
        ...
        if (baseClass == MBaseDevice.class) {
            switch (baseFeatureID) {
                case ModelPackage.MBASE_DEVICE__LOGGER:
                    return ModelPackage.VC_DEVICE_POWER__LOGGER;
                case ModelPackage.MBASE_DEVICE__UID:
                    return ModelPackage.VC_DEVICE_POWER__UID;
                case ModelPackage.MBASE_DEVICE__POLL:
                    return ModelPackage.VC_DEVICE_POWER__POLL;
                case ModelPackage.MBASE_DEVICE__ENABLED_A:
                    return ModelPackage.VC_DEVICE_POWER__ENABLED_A;
                default:
                    return -1;
            }
        }
        if (baseClass == MSubDevice.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSUB_DEVICE__SUB_ID:
                    return ModelPackage.VC_DEVICE_POWER__SUB_ID;
                case ModelPackage.MSUB_DEVICE__MBRICK:
                    return ModelPackage.VC_DEVICE_POWER__MBRICK;
                default:
                    return -1;
            }
        }
        if (baseClass == CallbackListener.class) {
            switch (baseFeatureID) {
                case ModelPackage.CALLBACK_LISTENER__CALLBACK_PERIOD:
                    return ModelPackage.VC_DEVICE_POWER__CALLBACK_PERIOD;
                default:
                    return -1;
            }
        }
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.VC_DEVICE_POWER__TF_CONFIG;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MBaseDevice.class) {
            switch (baseOperationID) {
                case ModelPackage.MBASE_DEVICE___INIT:
                    return ModelPackage.VC_DEVICE_POWER___INIT;
                case ModelPackage.MBASE_DEVICE___ENABLE:
                    return ModelPackage.VC_DEVICE_POWER___ENABLE;
                case ModelPackage.MBASE_DEVICE___DISABLE:
                    return ModelPackage.VC_DEVICE_POWER___DISABLE;
                default:
                    return -1;
            }
        }
