...
public enum VoltageCurrentSubIds implements Enumerator {
     ...
     * @generated
     */
    private static final VoltageCurrentSubIds[] VALUES_ARRAY = new VoltageCurrentSubIds[] { VOLTAGECURRENT_VOLTAGE,
    ...
    public static VoltageCurrentSubIds get(int value) {
        switch (value) {
            case VOLTAGECURRENT_VOLTAGE_VALUE:
                return VOLTAGECURRENT_VOLTAGE;
        }
        return null;
    }
