...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>VC Device Current</b></em>'.
 *
 * @author Theo Weiss
 * @since 1.5.0
 *        <!-- end-user-doc -->
 ...
 *        </p>
 *        <ul>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.VCDeviceCurrentImpl#getSensorValue <em>Sensor
 *        Value</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.VCDeviceCurrentImpl#getLogger
 *        <em>Logger</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.VCDeviceCurrentImpl#getUid <em>Uid</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.VCDeviceCurrentImpl#isPoll <em>Poll</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.VCDeviceCurrentImpl#getEnabledA <em>Enabled
 *        A</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.VCDeviceCurrentImpl#getSubId <em>Sub
 *        Id</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.VCDeviceCurrentImpl#getMbrick
 *        <em>Mbrick</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.VCDeviceCurrentImpl#getCallbackPeriod
 *        <em>Callback Period</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.VCDeviceCurrentImpl#getTfConfig <em>Tf
 *        Config</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.VCDeviceCurrentImpl#getDeviceType <em>Device
 *        Type</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.VCDeviceCurrentImpl#getThreshold
 *        <em>Threshold</em>}</li>
 *        </ul>
 *
 * @generated
 */
public class VCDeviceCurrentImpl extends MinimalEObjectImpl.Container implements VCDeviceCurrent {
    /**
     ...
     * @ordered
     */
    protected static final String DEVICE_TYPE_EDEFAULT = "voltageCurrent_current";
    ...
    protected EClass eStaticClass() {
        return ModelPackage.Literals.VC_DEVICE_CURRENT;
    }
    ...
    public void setSensorValue(DecimalValue newSensorValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.VC_DEVICE_CURRENT__SENSOR_VALUE,
    ...
    public void setLogger(Logger newLogger) {
        ...
        logger = newLogger;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.VC_DEVICE_CURRENT__LOGGER, oldLogger,
                    logger));
    }
    ...
    public void setEnabledA(AtomicBoolean newEnabledA) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.VC_DEVICE_CURRENT__ENABLED_A,
    ...
    public void setSubId(String newSubId) {
        ...
        subId = newSubId;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.VC_DEVICE_CURRENT__SUB_ID, oldSubId,
                    subId));
    }
    ...
    public MBrickletVoltageCurrent getMbrick() {
        if (eContainerFeatureID() != ModelPackage.VC_DEVICE_CURRENT__MBRICK)
            return null;
    ...
    public NotificationChain basicSetMbrick(MBrickletVoltageCurrent newMbrick, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newMbrick, ModelPackage.VC_DEVICE_CURRENT__MBRICK, msgs);
        return msgs;
    }
    ...
    public void setMbrick(MBrickletVoltageCurrent newMbrick) {
        if (newMbrick != eInternalContainer()
                || (eContainerFeatureID() != ModelPackage.VC_DEVICE_CURRENT__MBRICK && newMbrick != null)) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.VC_DEVICE_CURRENT__MBRICK, newMbrick,
                    newMbrick));
    }
    ...
    public void setCallbackPeriod(long newCallbackPeriod) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.VC_DEVICE_CURRENT__CALLBACK_PERIOD,
    ...
    public NotificationChain basicSetTfConfig(TFBaseConfiguration newTfConfig, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ModelPackage.VC_DEVICE_CURRENT__TF_CONFIG, oldTfConfig, newTfConfig);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newTfConfig != tfConfig) {
            ...
            if (tfConfig != null)
                msgs = ((InternalEObject) tfConfig).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ModelPackage.VC_DEVICE_CURRENT__TF_CONFIG, null, msgs);
            if (newTfConfig != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.VC_DEVICE_CURRENT__TF_CONFIG,
    ...
    public void setThreshold(BigDecimal newThreshold) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.VC_DEVICE_CURRENT__THRESHOLD,
    ...
    public void init() {
        ...
        logger = LoggerFactory.getLogger(VCDeviceCurrentImpl.class);
    }
    ...
    public void enable() {
        ...
        try {
            ...
            tinkerforgeDevice.setCurrentCallbackPeriod(getCallbackPeriod());
     ...
     * @generated NOT
     */
    private class CurrentListener implements BrickletVoltageCurrent.CurrentListener {
        ...
        if (baseClass == MBaseDevice.class) {
            switch (baseOperationID) {
                case ModelPackage.MBASE_DEVICE___INIT:
                    return ModelPackage.VC_DEVICE_CURRENT___INIT;
                case ModelPackage.MBASE_DEVICE___ENABLE:
                    return ModelPackage.VC_DEVICE_CURRENT___ENABLE;
                case ModelPackage.MBASE_DEVICE___DISABLE:
                    return ModelPackage.VC_DEVICE_CURRENT___DISABLE;
                default:
                    return -1;
            }
        }
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            case ModelPackage.VC_DEVICE_CURRENT___INIT:
                init();
                return null;
            case ModelPackage.VC_DEVICE_CURRENT___ENABLE:
                enable();
                return null;
            case ModelPackage.VC_DEVICE_CURRENT___DISABLE:
                disable();
                return null;
            case ModelPackage.VC_DEVICE_CURRENT___FETCH_SENSOR_VALUE:
                fetchSensorValue();
                return null;
        }
