...
public class RemoteSwitchBImpl extends MinimalEObjectImpl.Container implements RemoteSwitchB {
    ...
    public void setValue(PercentType newValue, DeviceOptions opts) {
        ...
        short value = getMaxValue().multiply(newValue.toBigDecimal())
    ...
    private void dimm(Short newDimmValue) {
        ...
        try {
            ...
            if (newDimmValue == getMinValue().shortValue()) {
                ...
                logger.debug("*** newValue {}", (new BigDecimal(newDimmValue)
                        .divide(getMaxValue(), 2, RoundingMode.HALF_UP).multiply(new BigDecimal(100))));
                dimmState = new PercentValue(new BigDecimal(newDimmValue).divide(getMaxValue(), 2, RoundingMode.HALF_UP)
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.REMOTE_SWITCH_B__ABS_DIMM_VALUE:
                return ABS_DIMM_VALUE_EDEFAULT == null ? absDimmValue != null
                        : !ABS_DIMM_VALUE_EDEFAULT.equals(absDimmValue);
        }
        ...
        if (baseClass == SwitchSensor.class) {
            switch (baseOperationID) {
                case ModelPackage.SWITCH_SENSOR___FETCH_SWITCH_STATE:
                    return ModelPackage.REMOTE_SWITCH_B___FETCH_SWITCH_STATE;
                default:
                    return -1;
            }
        }
        if (baseClass == MSwitchActor.class) {
            switch (baseOperationID) {
                case ModelPackage.MSWITCH_ACTOR___TURN_SWITCH__ONOFFVALUE:
                    return ModelPackage.REMOTE_SWITCH_B___TURN_SWITCH__ONOFFVALUE;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MBaseDevice.class) {
            switch (baseOperationID) {
                case ModelPackage.MBASE_DEVICE___INIT:
                    return ModelPackage.REMOTE_SWITCH_B___INIT;
                case ModelPackage.MBASE_DEVICE___ENABLE:
                    return ModelPackage.REMOTE_SWITCH_B___ENABLE;
                case ModelPackage.MBASE_DEVICE___DISABLE:
                    return ModelPackage.REMOTE_SWITCH_B___DISABLE;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == DimmableActor.class) {
            switch (baseOperationID) {
                case ModelPackage.DIMMABLE_ACTOR___DIMM__INCREASEDECREASETYPE_DEVICEOPTIONS:
                    return ModelPackage.REMOTE_SWITCH_B___DIMM__INCREASEDECREASETYPE_DEVICEOPTIONS;
                default:
                    return -1;
            }
        }
        if (baseClass == PercentTypeActor.class) {
            switch (baseOperationID) {
                case ModelPackage.PERCENT_TYPE_ACTOR___SET_VALUE__PERCENTTYPE_DEVICEOPTIONS:
                    return ModelPackage.REMOTE_SWITCH_B___SET_VALUE__PERCENTTYPE_DEVICEOPTIONS;
                default:
                    return -1;
            }
        }
