...
public enum DualButtonLedSubIds implements Enumerator {
     ...
     * @generated
     */
    private static final DualButtonLedSubIds[] VALUES_ARRAY = new DualButtonLedSubIds[] { DUALBUTTON_LEFTLED,
            DUALBUTTON_RIGHTLED, };
    ...
    public static DualButtonLedSubIds get(int value) {
        switch (value) {
            case DUALBUTTON_LEFTLED_VALUE:
                return DUALBUTTON_LEFTLED;
        }
        return null;
    }
