 ...
 * Config</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.LaserRangeFinderDistanceImpl#getSensorValue <em>Sensor
 * Value</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.LaserRangeFinderDistanceImpl#getCallbackPeriod
 * <em>Callback Period</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.LaserRangeFinderDistanceImpl#getDeviceType <em>Device
 * Type</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.LaserRangeFinderDistanceImpl#getThreshold
 * <em>Threshold</em>}</li>
 * </ul>
 *
 * @generated
...
public class LaserRangeFinderDistanceImpl extends MinimalEObjectImpl.Container implements LaserRangeFinderDistance {
    ...
    public void setLogger(Logger newLogger) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.LASER_RANGE_FINDER_DISTANCE__LOGGER,
                    oldLogger, logger));
    }
    ...
    public void setUid(String newUid) {
        ...
        uid = newUid;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.LASER_RANGE_FINDER_DISTANCE__UID, oldUid,
                    uid));
    }
    ...
    public void setPoll(boolean newPoll) {
        ...
        poll = newPoll;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.LASER_RANGE_FINDER_DISTANCE__POLL,
                    oldPoll, poll));
    }
    ...
    public void setEnabledA(AtomicBoolean newEnabledA) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.LASER_RANGE_FINDER_DISTANCE__ENABLED_A,
    ...
    public void setSubId(String newSubId) {
        ...
        subId = newSubId;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.LASER_RANGE_FINDER_DISTANCE__SUB_ID,
                    oldSubId, subId));
    }
    ...
    public MBrickletLaserRangeFinder getMbrick() {
        if (eContainerFeatureID() != ModelPackage.LASER_RANGE_FINDER_DISTANCE__MBRICK)
            return null;
    ...
    public void setSensorValue(DecimalValue newSensorValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ModelPackage.LASER_RANGE_FINDER_DISTANCE__SENSOR_VALUE, oldSensorValue, sensorValue));
    }
    ...
    public NotificationChain basicSetTfConfig(TFBaseConfiguration newTfConfig, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ModelPackage.LASER_RANGE_FINDER_DISTANCE__TF_CONFIG, oldTfConfig, newTfConfig);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newTfConfig != tfConfig) {
            ...
            if (tfConfig != null)
                msgs = ((InternalEObject) tfConfig).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ModelPackage.LASER_RANGE_FINDER_DISTANCE__TF_CONFIG, null, msgs);
            if (newTfConfig != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.LASER_RANGE_FINDER_DISTANCE__TF_CONFIG,
    ...
    public void setCallbackPeriod(long newCallbackPeriod) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    ModelPackage.LASER_RANGE_FINDER_DISTANCE__CALLBACK_PERIOD, oldCallbackPeriod, callbackPeriod));
    }
    ...
    public void setThreshold(BigDecimal newThreshold) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.LASER_RANGE_FINDER_DISTANCE__THRESHOLD,
        ...
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.LASER_RANGE_FINDER_DISTANCE__TF_CONFIG;
                default:
                    return -1;
            }
        }
        if (baseClass == MSensor.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSENSOR__SENSOR_VALUE:
                    return ModelPackage.LASER_RANGE_FINDER_DISTANCE__SENSOR_VALUE;
                default:
                    return -1;
            }
        }
        if (baseClass == CallbackListener.class) {
            switch (baseFeatureID) {
                case ModelPackage.CALLBACK_LISTENER__CALLBACK_PERIOD:
                    return ModelPackage.LASER_RANGE_FINDER_DISTANCE__CALLBACK_PERIOD;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSensor.class) {
            switch (baseOperationID) {
                case ModelPackage.MSENSOR___FETCH_SENSOR_VALUE:
                    return ModelPackage.LASER_RANGE_FINDER_DISTANCE___FETCH_SENSOR_VALUE;
                default:
                    return -1;
            }
        }
