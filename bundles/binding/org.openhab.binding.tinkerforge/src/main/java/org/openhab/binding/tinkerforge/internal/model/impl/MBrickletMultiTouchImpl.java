    ...
    public void enable() {
        if (tfConfig != null) {
            if (tfConfig.eIsSet(tfConfig.eClass().getEStructuralFeature("sensitivity"))) {
                ...
                logger.debug("{} MultiTouchDevice uid {} setSensitivity {}", LoggerConstants.TFINIT, getUid(),
                        getSensitivity());
            }
            if (tfConfig.eIsSet(tfConfig.eClass().getEStructuralFeature("recalibrate"))) {
                setRecalibrate(tfConfig.getRecalibrate());
                logger.debug("{} MultiTouchDevice uid {} setRecalibrate {}", LoggerConstants.TFINIT, getUid(),
                        getRecalibrate());
            }
        }
        ...
        if (baseClass == MSubDeviceHolder.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSUB_DEVICE_HOLDER__MSUBDEVICES:
                    return ModelPackage.MBRICKLET_MULTI_TOUCH__MSUBDEVICES;
                default:
                    return -1;
            }
        }
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.MBRICKLET_MULTI_TOUCH__TF_CONFIG;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSubDeviceHolder.class) {
            switch (baseOperationID) {
                case ModelPackage.MSUB_DEVICE_HOLDER___INIT_SUB_DEVICES:
                    return ModelPackage.MBRICKLET_MULTI_TOUCH___INIT_SUB_DEVICES;
                default:
                    return -1;
            }
        }
