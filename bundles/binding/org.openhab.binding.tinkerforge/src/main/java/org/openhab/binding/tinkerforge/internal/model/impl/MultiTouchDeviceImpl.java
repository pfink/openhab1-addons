...
public class MultiTouchDeviceImpl extends MinimalEObjectImpl.Container implements MultiTouchDevice {
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.MULTI_TOUCH_DEVICE__DISABLE_ELECTRODE:
                return DISABLE_ELECTRODE_EDEFAULT == null ? disableElectrode != null
                        : !DISABLE_ELECTRODE_EDEFAULT.equals(disableElectrode);
        }
        ...
        if (baseClass == MSensor.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSENSOR__SENSOR_VALUE:
                    return ModelPackage.MULTI_TOUCH_DEVICE__SENSOR_VALUE;
                default:
                    return -1;
            }
        }
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.MULTI_TOUCH_DEVICE__TF_CONFIG;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSensor.class) {
            switch (baseOperationID) {
                case ModelPackage.MSENSOR___FETCH_SENSOR_VALUE:
                    return ModelPackage.MULTI_TOUCH_DEVICE___FETCH_SENSOR_VALUE;
                default:
                    return -1;
            }
        }
