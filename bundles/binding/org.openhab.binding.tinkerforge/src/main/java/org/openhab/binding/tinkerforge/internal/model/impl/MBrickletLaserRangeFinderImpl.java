...
public class MBrickletLaserRangeFinderImpl extends MinimalEObjectImpl.Container implements MBrickletLaserRangeFinder {
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.MBRICKLET_LASER_RANGE_FINDER__ENABLE_LASER_ON_STARTUP:
                return ENABLE_LASER_ON_STARTUP_EDEFAULT == null ? enableLaserOnStartup != null
                        : !ENABLE_LASER_ON_STARTUP_EDEFAULT.equals(enableLaserOnStartup);
        }
        ...
        if (baseClass == MSubDeviceHolder.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSUB_DEVICE_HOLDER__MSUBDEVICES:
                    return ModelPackage.MBRICKLET_LASER_RANGE_FINDER__MSUBDEVICES;
                default:
                    return -1;
            }
        }
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.MBRICKLET_LASER_RANGE_FINDER__TF_CONFIG;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSubDeviceHolder.class) {
            switch (baseOperationID) {
                case ModelPackage.MSUB_DEVICE_HOLDER___INIT_SUB_DEVICES:
                    return ModelPackage.MBRICKLET_LASER_RANGE_FINDER___INIT_SUB_DEVICES;
                default:
                    return -1;
            }
        }
