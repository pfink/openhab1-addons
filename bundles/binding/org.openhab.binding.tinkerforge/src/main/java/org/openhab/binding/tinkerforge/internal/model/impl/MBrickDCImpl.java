...
public class MBrickDCImpl extends MinimalEObjectImpl.Container implements MBrickDC {
    ...
    public void setValue(PercentType percentValue, DeviceOptions opts) {
        ...
        Short newVelocity = abs.divide(new BigDecimal(100)).multiply(percentValue.toBigDecimal()).subtract(min.abs())
                .shortValue();
        ...
        if (baseClass == SwitchSensor.class) {
            switch (baseFeatureID) {
                case ModelPackage.SWITCH_SENSOR__SWITCH_STATE:
                    return ModelPackage.MBRICK_DC__SWITCH_STATE;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MBaseDevice.class) {
            switch (baseFeatureID) {
                case ModelPackage.MBASE_DEVICE__LOGGER:
                    return ModelPackage.MBRICK_DC__LOGGER;
                case ModelPackage.MBASE_DEVICE__UID:
                    return ModelPackage.MBRICK_DC__UID;
                case ModelPackage.MBASE_DEVICE__POLL:
                    return ModelPackage.MBRICK_DC__POLL;
                case ModelPackage.MBASE_DEVICE__ENABLED_A:
                    return ModelPackage.MBRICK_DC__ENABLED_A;
                default:
                    return -1;
            }
        }
        if (baseClass == MDevice.class) {
            switch (baseFeatureID) {
                case ModelPackage.MDEVICE__TINKERFORGE_DEVICE:
                    return ModelPackage.MBRICK_DC__TINKERFORGE_DEVICE;
                case ModelPackage.MDEVICE__IP_CONNECTION:
                    return ModelPackage.MBRICK_DC__IP_CONNECTION;
                case ModelPackage.MDEVICE__CONNECTED_UID:
                    return ModelPackage.MBRICK_DC__CONNECTED_UID;
                case ModelPackage.MDEVICE__POSITION:
                    return ModelPackage.MBRICK_DC__POSITION;
                ...
                case ModelPackage.MDEVICE__NAME:
                    return ModelPackage.MBRICK_DC__NAME;
                case ModelPackage.MDEVICE__BRICKD:
                    return ModelPackage.MBRICK_DC__BRICKD;
                default:
                    return -1;
            }
        }
        if (baseClass == MoveActor.class) {
            switch (baseFeatureID) {
                case ModelPackage.MOVE_ACTOR__DIRECTION:
                    return ModelPackage.MBRICK_DC__DIRECTION;
                default:
                    return -1;
            }
        }
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.MBRICK_DC__TF_CONFIG;
                default:
                    return -1;
            }
        }
        if (baseClass == DimmableActor.class) {
            switch (baseFeatureID) {
                case ModelPackage.DIMMABLE_ACTOR__MIN_VALUE:
                    return ModelPackage.MBRICK_DC__MIN_VALUE;
                case ModelPackage.DIMMABLE_ACTOR__MAX_VALUE:
                    return ModelPackage.MBRICK_DC__MAX_VALUE;
                default:
                    return -1;
            }
        }
        if (baseClass == PercentTypeActor.class) {
            switch (baseFeatureID) {
                case ModelPackage.PERCENT_TYPE_ACTOR__PERCENT_VALUE:
                    return ModelPackage.MBRICK_DC__PERCENT_VALUE;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == CallbackListener.class) {
            switch (baseFeatureID) {
                case ModelPackage.CALLBACK_LISTENER__CALLBACK_PERIOD:
                    return ModelPackage.MBRICK_DC__CALLBACK_PERIOD;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == SwitchSensor.class) {
            switch (baseOperationID) {
                case ModelPackage.SWITCH_SENSOR___FETCH_SWITCH_STATE:
                    return ModelPackage.MBRICK_DC___FETCH_SWITCH_STATE;
                default:
                    return -1;
            }
        }
        if (baseClass == ProgrammableSwitchActor.class) {
            switch (baseOperationID) {
                case ModelPackage.PROGRAMMABLE_SWITCH_ACTOR___TURN_SWITCH__ONOFFVALUE_DEVICEOPTIONS:
                    return ModelPackage.MBRICK_DC___TURN_SWITCH__ONOFFVALUE_DEVICEOPTIONS;
                default:
                    return -1;
            }
        }
        if (baseClass == MBaseDevice.class) {
            switch (baseOperationID) {
                case ModelPackage.MBASE_DEVICE___INIT:
                    return ModelPackage.MBRICK_DC___INIT;
                case ModelPackage.MBASE_DEVICE___ENABLE:
                    return ModelPackage.MBRICK_DC___ENABLE;
                case ModelPackage.MBASE_DEVICE___DISABLE:
                    return ModelPackage.MBRICK_DC___DISABLE;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MoveActor.class) {
            switch (baseOperationID) {
                case ModelPackage.MOVE_ACTOR___MOVE__UPDOWNTYPE_DEVICEOPTIONS:
                    return ModelPackage.MBRICK_DC___MOVE__UPDOWNTYPE_DEVICEOPTIONS;
                case ModelPackage.MOVE_ACTOR___STOP:
                    return ModelPackage.MBRICK_DC___STOP;
                case ModelPackage.MOVE_ACTOR___MOVEON__DEVICEOPTIONS:
                    return ModelPackage.MBRICK_DC___MOVEON__DEVICEOPTIONS;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == DimmableActor.class) {
            switch (baseOperationID) {
                case ModelPackage.DIMMABLE_ACTOR___DIMM__INCREASEDECREASETYPE_DEVICEOPTIONS:
                    return ModelPackage.MBRICK_DC___DIMM__INCREASEDECREASETYPE_DEVICEOPTIONS;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == SetPointActor.class) {
            switch (baseOperationID) {
                case ModelPackage.SET_POINT_ACTOR___SET_VALUE__BIGDECIMAL_DEVICEOPTIONS:
                    return ModelPackage.MBRICK_DC___SET_VALUE__BIGDECIMAL_DEVICEOPTIONS;
                default:
                    return -1;
            }
        }
