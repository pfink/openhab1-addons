 ...
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletVoltageCurrentImpl#getConnectedUid
 *        <em>Connected Uid</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletVoltageCurrentImpl#getPosition
 *        <em>Position</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletVoltageCurrentImpl#getDeviceIdentifier
 *        <em>Device Identifier</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletVoltageCurrentImpl#getName
 *        <em>Name</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletVoltageCurrentImpl#getBrickd
 *        <em>Brickd</em>}</li>
...
public class MBrickletVoltageCurrentImpl extends MinimalEObjectImpl.Container implements MBrickletVoltageCurrent {
    ...
    public void enable() {
        if (tfConfig != null) {
            ...
            if (tfConfig.eIsSet(tfConfig.eClass().getEStructuralFeature("voltageConversionTime"))) {
                ...
                logger.debug("{} VoltageCurrent uid {} voltageConversionTime {}", LoggerConstants.TFINIT, getUid(),
            ...
            if (tfConfig.eIsSet(tfConfig.eClass().getEStructuralFeature("currentConversionTime"))) {
                ...
                logger.debug("{} VoltageCurrent uid {} currentConversionTime {}", LoggerConstants.TFINIT, getUid(),
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.MBRICKLET_VOLTAGE_CURRENT__VOLTAGE_CONVERSION_TIME:
                return VOLTAGE_CONVERSION_TIME_EDEFAULT == null ? voltageConversionTime != null
                        : !VOLTAGE_CONVERSION_TIME_EDEFAULT.equals(voltageConversionTime);
            case ModelPackage.MBRICKLET_VOLTAGE_CURRENT__CURRENT_CONVERSION_TIME:
                return CURRENT_CONVERSION_TIME_EDEFAULT == null ? currentConversionTime != null
                        : !CURRENT_CONVERSION_TIME_EDEFAULT.equals(currentConversionTime);
        }
        ...
        if (baseClass == MSubDeviceHolder.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSUB_DEVICE_HOLDER__MSUBDEVICES:
                    return ModelPackage.MBRICKLET_VOLTAGE_CURRENT__MSUBDEVICES;
                default:
                    return -1;
            }
        }
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.MBRICKLET_VOLTAGE_CURRENT__TF_CONFIG;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSubDeviceHolder.class) {
            switch (baseOperationID) {
                case ModelPackage.MSUB_DEVICE_HOLDER___INIT_SUB_DEVICES:
                    return ModelPackage.MBRICKLET_VOLTAGE_CURRENT___INIT_SUB_DEVICES;
                default:
                    return -1;
            }
        }
