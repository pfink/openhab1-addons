...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MBricklet Dust Detector</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * <em>Position</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletDustDetectorImpl#getDeviceIdentifier
 ...
 * @generated
 */
public class MBrickletDustDetectorImpl extends MinimalEObjectImpl.Container implements MBrickletDustDetector {
    /**
     ...
     * @ordered
     */
    protected BrickletDustDetector tinkerforgeDevice;
     ...
     * @ordered
     */
    protected static final String DEVICE_TYPE_EDEFAULT = "bricklet_dustdetector";
    ...
    private DustDensityListener listener;
     ...
     * @generated
     */
    protected MBrickletDustDetectorImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return ModelPackage.Literals.MBRICKLET_DUST_DETECTOR;
    }
     ...
     */
    @Override
    public BrickletDustDetector getTinkerforgeDevice() {
    ...
    public NotificationChain basicSetBrickd(MBrickd newBrickd, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newBrickd, ModelPackage.MBRICKLET_DUST_DETECTOR__BRICKD, msgs);
        return msgs;
    }
    ...
    public void init() {
        ...
        logger = LoggerFactory.getLogger(MBrickletDustDetectorImpl.class);
    }
    ...
    private class DustDensityListener implements BrickletDustDetector.DustDensityListener {

        @Override
        public void dustDensity(int newValue) {
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case ModelPackage.MBRICKLET_DUST_DETECTOR__ENABLED_A:
                ...
                return;
            case ModelPackage.MBRICKLET_DUST_DETECTOR__TINKERFORGE_DEVICE:
                setTinkerforgeDevice((BrickletDustDetector) newValue);
                return;
            case ModelPackage.MBRICKLET_DUST_DETECTOR__IP_CONNECTION:
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.MBRICKLET_DUST_DETECTOR__ENABLED_A:
                ...
                return;
            case ModelPackage.MBRICKLET_DUST_DETECTOR__TINKERFORGE_DEVICE:
                setTinkerforgeDevice((BrickletDustDetector) null);
                return;
            case ModelPackage.MBRICKLET_DUST_DETECTOR__IP_CONNECTION:
        ...
        if (baseClass == MSensor.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSENSOR__SENSOR_VALUE:
                    return ModelPackage.MBRICKLET_DUST_DETECTOR__SENSOR_VALUE;
                default:
                    return -1;
            }
        }
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.MBRICKLET_DUST_DETECTOR__TF_CONFIG;
                default:
                    return -1;
            }
        }
        if (baseClass == CallbackListener.class) {
            switch (baseFeatureID) {
                case ModelPackage.CALLBACK_LISTENER__CALLBACK_PERIOD:
                    return ModelPackage.MBRICKLET_DUST_DETECTOR__CALLBACK_PERIOD;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSensor.class) {
            switch (baseOperationID) {
                case ModelPackage.MSENSOR___FETCH_SENSOR_VALUE:
                    return ModelPackage.MBRICKLET_DUST_DETECTOR___FETCH_SENSOR_VALUE;
                default:
                    return -1;
            }
        }
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            case ModelPackage.MBRICKLET_DUST_DETECTOR___INIT:
                init();
                return null;
            case ModelPackage.MBRICKLET_DUST_DETECTOR___FETCH_SENSOR_VALUE:
                fetchSensorValue();
                return null;
            case ModelPackage.MBRICKLET_DUST_DETECTOR___ENABLE:
                enable();
                return null;
            case ModelPackage.MBRICKLET_DUST_DETECTOR___DISABLE:
                disable();
                return null;
        }
