 ...
 * <em>Position</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletAccelerometerImpl#getDeviceIdentifier
 ...
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletAccelerometerImpl#getBrickd <em>Brickd</em>}
 * </li>
...
public class MBrickletAccelerometerImpl extends MinimalEObjectImpl.Container implements MBrickletAccelerometer {
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.MBRICKLET_ACCELEROMETER__FILTER_BANDWIDTH:
                return FILTER_BANDWIDTH_EDEFAULT == null ? filterBandwidth != null
                        : !FILTER_BANDWIDTH_EDEFAULT.equals(filterBandwidth);
        }
        ...
        if (baseClass == MSubDeviceHolder.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSUB_DEVICE_HOLDER__MSUBDEVICES:
                    return ModelPackage.MBRICKLET_ACCELEROMETER__MSUBDEVICES;
                default:
                    return -1;
            }
        }
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.MBRICKLET_ACCELEROMETER__TF_CONFIG;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSubDeviceHolder.class) {
            switch (baseOperationID) {
                case ModelPackage.MSUB_DEVICE_HOLDER___INIT_SUB_DEVICES:
                    return ModelPackage.MBRICKLET_ACCELEROMETER___INIT_SUB_DEVICES;
                default:
                    return -1;
            }
        }
