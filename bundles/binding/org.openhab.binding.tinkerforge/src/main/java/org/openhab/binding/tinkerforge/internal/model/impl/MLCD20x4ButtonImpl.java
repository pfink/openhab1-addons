 ...
 *        </p>
 *        <ul>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD20x4ButtonImpl#getSensorValue <em>Sensor
 *        Value</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD20x4ButtonImpl#getLogger
 *        <em>Logger</em>}</li>
 ...
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD20x4ButtonImpl#getEnabledA <em>Enabled
 *        A</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD20x4ButtonImpl#getSubId <em>Sub
 *        Id</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD20x4ButtonImpl#getMbrick
 *        <em>Mbrick</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD20x4ButtonImpl#getTfConfig <em>Tf
 *        Config</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD20x4ButtonImpl#getDeviceType <em>Device
 *        Type</em>}</li>
 *        <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD20x4ButtonImpl#getButtonNum <em>Button
 *        Num</em>}</li>
 *        </ul>
 *
 * @generated
...
public class MLCD20x4ButtonImpl extends MinimalEObjectImpl.Container implements MLCD20x4Button {
    ...
    public void setSensorValue(OnOffValue newSensorValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MLCD2_0X4_BUTTON__SENSOR_VALUE,
    ...
    public void setLogger(Logger newLogger) {
        ...
        logger = newLogger;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MLCD2_0X4_BUTTON__LOGGER, oldLogger,
                    logger));
    }
    ...
    public void setEnabledA(AtomicBoolean newEnabledA) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MLCD2_0X4_BUTTON__ENABLED_A, oldEnabledA,
                    enabledA));
    }
    ...
    public void setSubId(String newSubId) {
        ...
        subId = newSubId;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MLCD2_0X4_BUTTON__SUB_ID, oldSubId,
                    subId));
    }
    ...
    public MBrickletLCD20x4 getMbrick() {
        if (eContainerFeatureID() != ModelPackage.MLCD2_0X4_BUTTON__MBRICK)
            return null;
    ...
    public void setMbrick(MBrickletLCD20x4 newMbrick) {
        if (newMbrick != eInternalContainer()
                || (eContainerFeatureID() != ModelPackage.MLCD2_0X4_BUTTON__MBRICK && newMbrick != null)) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MLCD2_0X4_BUTTON__MBRICK, newMbrick,
                    newMbrick));
    }
    ...
    public NotificationChain basicSetTfConfig(ButtonConfiguration newTfConfig, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ModelPackage.MLCD2_0X4_BUTTON__TF_CONFIG, oldTfConfig, newTfConfig);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newTfConfig != tfConfig) {
            ...
            if (tfConfig != null)
                msgs = ((InternalEObject) tfConfig).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ModelPackage.MLCD2_0X4_BUTTON__TF_CONFIG, null, msgs);
            if (newTfConfig != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MLCD2_0X4_BUTTON__TF_CONFIG, newTfConfig,
                    newTfConfig));
    }
    ...
    public void setButtonNum(short newButtonNum) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MLCD2_0X4_BUTTON__BUTTON_NUM,
    ...
    private class ButtonListener
            implements BrickletLCD20x4.ButtonPressedListener, BrickletLCD20x4.ButtonReleasedListener {
        ...
        if (baseClass == MBaseDevice.class) {
            switch (baseFeatureID) {
                case ModelPackage.MBASE_DEVICE__LOGGER:
                    return ModelPackage.MLCD2_0X4_BUTTON__LOGGER;
                case ModelPackage.MBASE_DEVICE__UID:
                    return ModelPackage.MLCD2_0X4_BUTTON__UID;
                case ModelPackage.MBASE_DEVICE__POLL:
                    return ModelPackage.MLCD2_0X4_BUTTON__POLL;
                case ModelPackage.MBASE_DEVICE__ENABLED_A:
                    return ModelPackage.MLCD2_0X4_BUTTON__ENABLED_A;
                default:
                    return -1;
            }
        }
        if (baseClass == MSubDevice.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSUB_DEVICE__SUB_ID:
                    return ModelPackage.MLCD2_0X4_BUTTON__SUB_ID;
                case ModelPackage.MSUB_DEVICE__MBRICK:
                    return ModelPackage.MLCD2_0X4_BUTTON__MBRICK;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.MLCD2_0X4_BUTTON__TF_CONFIG;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MBaseDevice.class) {
            switch (baseOperationID) {
                case ModelPackage.MBASE_DEVICE___INIT:
                    return ModelPackage.MLCD2_0X4_BUTTON___INIT;
                case ModelPackage.MBASE_DEVICE___ENABLE:
                    return ModelPackage.MLCD2_0X4_BUTTON___ENABLE;
                case ModelPackage.MBASE_DEVICE___DISABLE:
                    return ModelPackage.MLCD2_0X4_BUTTON___DISABLE;
                default:
                    return -1;
            }
        }
