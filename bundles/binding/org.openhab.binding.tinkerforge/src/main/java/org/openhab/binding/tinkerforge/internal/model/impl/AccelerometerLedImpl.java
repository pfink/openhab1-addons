...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Accelerometer Led</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.AccelerometerLedImpl#isPoll <em>Poll</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.AccelerometerLedImpl#getEnabledA <em>Enabled A</em>}
 * </li>
 ...
 * @generated
 */
public class AccelerometerLedImpl extends MinimalEObjectImpl.Container implements AccelerometerLed {
    /**
     ...
     * @ordered
     */
    protected static final String DEVICE_TYPE_EDEFAULT = "accelerometer_led";
     ...
     * @generated
     */
    protected AccelerometerLedImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return ModelPackage.Literals.ACCELEROMETER_LED;
    }
    ...
    public NotificationChain basicSetMbrick(MBrickletAccelerometer newMbrick, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newMbrick, ModelPackage.ACCELEROMETER_LED__MBRICK, msgs);
        return msgs;
    }
    ...
    public void init() {
        ...
        logger = LoggerFactory.getLogger(AccelerometerLedImpl.class);
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ModelPackage.ACCELEROMETER_LED__LOGGER:
                return getLogger();
            case ModelPackage.ACCELEROMETER_LED__UID:
                return getUid();
            case ModelPackage.ACCELEROMETER_LED__POLL:
                return isPoll();
            case ModelPackage.ACCELEROMETER_LED__ENABLED_A:
                return getEnabledA();
        ...
        if (baseClass == DigitalActor.class) {
            switch (baseFeatureID) {
                case ModelPackage.DIGITAL_ACTOR__DIGITAL_STATE:
                    return ModelPackage.ACCELEROMETER_LED__DIGITAL_STATE;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == DigitalActor.class) {
            switch (baseOperationID) {
                case ModelPackage.DIGITAL_ACTOR___TURN_DIGITAL__HIGHLOWVALUE:
                    return ModelPackage.ACCELEROMETER_LED___TURN_DIGITAL__HIGHLOWVALUE;
                case ModelPackage.DIGITAL_ACTOR___FETCH_DIGITAL_VALUE:
                    return ModelPackage.ACCELEROMETER_LED___FETCH_DIGITAL_VALUE;
                default:
                    return -1;
            }
        }
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            case ModelPackage.ACCELEROMETER_LED___TURN_DIGITAL__HIGHLOWVALUE:
                turnDigital((HighLowValue) arguments.get(0));
                return null;
            case ModelPackage.ACCELEROMETER_LED___FETCH_DIGITAL_VALUE:
                fetchDigitalValue();
                return null;
            case ModelPackage.ACCELEROMETER_LED___INIT:
                init();
                return null;
            case ModelPackage.ACCELEROMETER_LED___ENABLE:
                enable();
                return null;
            case ModelPackage.ACCELEROMETER_LED___DISABLE:
                disable();
                return null;
        }
