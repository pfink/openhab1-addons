...
public class OHConfigImpl extends MinimalEObjectImpl.Container implements OHConfig {
    ...
    public EList<OHTFDevice<?, ?>> getOhTfDevices() {
        if (ohTfDevices == null) {
            ohTfDevices = new EObjectContainmentWithInverseEList<OHTFDevice<?, ?>>(OHTFDevice.class, this,
                    ModelPackage.OH_CONFIG__OH_TF_DEVICES, ModelPackage.OHTF_DEVICE__OH_CONFIG);
        }
        return ohTfDevices;
    }
