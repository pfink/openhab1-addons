...
public enum DualButtonButtonSubIds implements Enumerator {
     ...
     * @generated
     */
    private static final DualButtonButtonSubIds[] VALUES_ARRAY = new DualButtonButtonSubIds[] { DUALBUTTON_LEFTBUTTON,
    ...
    public static DualButtonButtonSubIds get(int value) {
        switch (value) {
            case DUALBUTTON_LEFTBUTTON_VALUE:
                return DUALBUTTON_LEFTBUTTON;
        }
        return null;
    }
