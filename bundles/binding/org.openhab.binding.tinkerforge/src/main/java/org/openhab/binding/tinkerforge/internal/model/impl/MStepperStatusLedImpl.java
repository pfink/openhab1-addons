 ...
 * </p>
 * <ul>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MStepperStatusLedImpl#getLogger <em>Logger</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MStepperStatusLedImpl#getUid <em>Uid</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MStepperStatusLedImpl#isPoll <em>Poll</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MStepperStatusLedImpl#getEnabledA <em>Enabled A</em>}
 * </li>
...
public class MStepperStatusLedImpl extends MinimalEObjectImpl.Container implements MStepperStatusLed {
    ...
    protected EClass eStaticClass() {
        return ModelPackage.Literals.MSTEPPER_STATUS_LED;
    }
    ...
    public void setLogger(Logger newLogger) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MSTEPPER_STATUS_LED__LOGGER, oldLogger,
                    logger));
        }
    }
    ...
    public void setPoll(boolean newPoll) {
        ...
        poll = newPoll;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MSTEPPER_STATUS_LED__POLL, oldPoll,
                    poll));
        }
    }
    ...
    public void setEnabledA(AtomicBoolean newEnabledA) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MSTEPPER_STATUS_LED__ENABLED_A,
    ...
    public void setSubId(String newSubId) {
        ...
        subId = newSubId;
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MSTEPPER_STATUS_LED__SUB_ID, oldSubId,
                    subId));
        }
    }
    ...
    public MBrickStepper getMbrick() {
        if (eContainerFeatureID() != ModelPackage.MSTEPPER_STATUS_LED__MBRICK) {
            return null;
        }
    ...
    public void setMbrick(MBrickStepper newMbrick) {
        if (newMbrick != eInternalContainer()
                || (eContainerFeatureID() != ModelPackage.MSTEPPER_STATUS_LED__MBRICK && newMbrick != null)) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MSTEPPER_STATUS_LED__MBRICK, newMbrick,
                    newMbrick));
        }
    }
    ...
    public void setDigitalState(HighLowValue newDigitalState) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MSTEPPER_STATUS_LED__DIGITAL_STATE,
        ...
        if (baseClass == DigitalActor.class) {
            switch (baseFeatureID) {
                case ModelPackage.DIGITAL_ACTOR__DIGITAL_STATE:
                    return ModelPackage.MSTEPPER_STATUS_LED__DIGITAL_STATE;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == DigitalActor.class) {
            switch (baseOperationID) {
                case ModelPackage.DIGITAL_ACTOR___TURN_DIGITAL__HIGHLOWVALUE:
                    return ModelPackage.MSTEPPER_STATUS_LED___TURN_DIGITAL__HIGHLOWVALUE;
                case ModelPackage.DIGITAL_ACTOR___FETCH_DIGITAL_VALUE:
                    return ModelPackage.MSTEPPER_STATUS_LED___FETCH_DIGITAL_VALUE;
                default:
                    return -1;
            }
        }
