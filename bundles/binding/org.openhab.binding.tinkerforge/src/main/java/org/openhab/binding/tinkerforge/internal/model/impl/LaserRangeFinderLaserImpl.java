        ...
        if (baseClass == DigitalActor.class) {
            switch (baseFeatureID) {
                case ModelPackage.DIGITAL_ACTOR__DIGITAL_STATE:
                    return ModelPackage.LASER_RANGE_FINDER_LASER__DIGITAL_STATE;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == DigitalActor.class) {
            switch (baseOperationID) {
                case ModelPackage.DIGITAL_ACTOR___TURN_DIGITAL__HIGHLOWVALUE:
                    return ModelPackage.LASER_RANGE_FINDER_LASER___TURN_DIGITAL__HIGHLOWVALUE;
                case ModelPackage.DIGITAL_ACTOR___FETCH_DIGITAL_VALUE:
                    return ModelPackage.LASER_RANGE_FINDER_LASER___FETCH_DIGITAL_VALUE;
                default:
                    return -1;
            }
        }
