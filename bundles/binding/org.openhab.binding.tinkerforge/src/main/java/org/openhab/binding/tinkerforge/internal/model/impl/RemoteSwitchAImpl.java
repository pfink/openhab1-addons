...
public class RemoteSwitchAImpl extends MinimalEObjectImpl.Container implements RemoteSwitchA {
    ...
    public void setSwitchState(OnOffValue newSwitchState) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REMOTE_SWITCH_A__SWITCH_STATE,
    ...
    public void setLogger(Logger newLogger) {
        ...
        logger = newLogger;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REMOTE_SWITCH_A__LOGGER, oldLogger,
                    logger));
    }
    ...
    public void setPoll(boolean newPoll) {
        ...
        poll = newPoll;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REMOTE_SWITCH_A__POLL, oldPoll, poll));
    }
    ...
    public void setEnabledA(AtomicBoolean newEnabledA) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REMOTE_SWITCH_A__ENABLED_A, oldEnabledA,
                    enabledA));
    }
    ...
    public void setSubId(String newSubId) {
        ...
        subId = newSubId;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REMOTE_SWITCH_A__SUB_ID, oldSubId,
                    subId));
    }
    ...
    public MBrickletRemoteSwitch getMbrick() {
        if (eContainerFeatureID() != ModelPackage.REMOTE_SWITCH_A__MBRICK)
            return null;
    ...
    public void setHouseCode(Short newHouseCode) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REMOTE_SWITCH_A__HOUSE_CODE,
    ...
    public void setReceiverCode(Short newReceiverCode) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REMOTE_SWITCH_A__RECEIVER_CODE,
                    oldReceiverCode, receiverCode));
    }
    ...
    public void setRepeats(Short newRepeats) {
        ...
        repeats = newRepeats;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REMOTE_SWITCH_A__REPEATS, oldRepeats,
                    repeats));
    }
    ...
    public NotificationChain basicSetTfConfig(RemoteSwitchAConfiguration newTfConfig, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ModelPackage.REMOTE_SWITCH_A__TF_CONFIG, oldTfConfig, newTfConfig);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newTfConfig != tfConfig) {
            ...
            if (tfConfig != null)
                msgs = ((InternalEObject) tfConfig).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - ModelPackage.REMOTE_SWITCH_A__TF_CONFIG, null, msgs);
            if (newTfConfig != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.REMOTE_SWITCH_A__TF_CONFIG, newTfConfig,
                    newTfConfig));
    }
    ...
    public void turnSwitch(OnOffValue state) {
        ...
        if (getHouseCode() != null && getReceiverCode() != null) {
            ...
            try {
                ...
                tinkerforgeDevice.switchSocketA(getHouseCode(), getReceiverCode(), switchTo);
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.REMOTE_SWITCH_A__RECEIVER_CODE:
                return RECEIVER_CODE_EDEFAULT == null ? receiverCode != null
                        : !RECEIVER_CODE_EDEFAULT.equals(receiverCode);
            case ModelPackage.REMOTE_SWITCH_A__REPEATS:
        ...
        if (baseClass == MBaseDevice.class) {
            switch (baseOperationID) {
                case ModelPackage.MBASE_DEVICE___INIT:
                    return ModelPackage.REMOTE_SWITCH_A___INIT;
                case ModelPackage.MBASE_DEVICE___ENABLE:
                    return ModelPackage.REMOTE_SWITCH_A___ENABLE;
                case ModelPackage.MBASE_DEVICE___DISABLE:
                    return ModelPackage.REMOTE_SWITCH_A___DISABLE;
                default:
                    return -1;
            }
        }
