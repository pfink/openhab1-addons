...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MStepper Steps</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MStepperStepsImpl#getLogger <em>Logger</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MStepperStepsImpl#getUid <em>Uid</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MStepperStepsImpl#isPoll <em>Poll</em>}</li>
 ...
 * @generated
 */
public class MStepperStepsImpl extends MinimalEObjectImpl.Container implements MStepperSteps {
    /**
     ...
     * @ordered
     */
    protected static final String DEVICE_TYPE_EDEFAULT = "stepper_steps";
    ...
    protected EClass eStaticClass() {
        return ModelPackage.Literals.MSTEPPER_STEPS;
    }
    ...
    public NotificationChain basicSetMbrick(MBrickStepper newMbrick, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newMbrick, ModelPackage.MSTEPPER_STEPS__MBRICK, msgs);
        return msgs;
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ModelPackage.MSTEPPER_STEPS__LOGGER:
                return getLogger();
            case ModelPackage.MSTEPPER_STEPS__UID:
                return getUid();
            case ModelPackage.MSTEPPER_STEPS__POLL:
                return isPoll();
            case ModelPackage.MSTEPPER_STEPS__ENABLED_A:
                return getEnabledA();
            ...
            case ModelPackage.MSTEPPER_STEPS__DEVICE_TYPE:
        ...
        if (baseClass == MSensor.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSENSOR__SENSOR_VALUE:
                    return ModelPackage.MSTEPPER_STEPS__SENSOR_VALUE;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSensor.class) {
            switch (baseOperationID) {
                case ModelPackage.MSENSOR___FETCH_SENSOR_VALUE:
                    return ModelPackage.MSTEPPER_STEPS___FETCH_SENSOR_VALUE;
                default:
                    return -1;
            }
        }
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            case ModelPackage.MSTEPPER_STEPS___FETCH_SENSOR_VALUE:
                fetchSensorValue();
                return null;
            case ModelPackage.MSTEPPER_STEPS___INIT:
                init();
                return null;
            case ModelPackage.MSTEPPER_STEPS___ENABLE:
                enable();
                return null;
            case ModelPackage.MSTEPPER_STEPS___DISABLE:
                disable();
                return null;
        }
