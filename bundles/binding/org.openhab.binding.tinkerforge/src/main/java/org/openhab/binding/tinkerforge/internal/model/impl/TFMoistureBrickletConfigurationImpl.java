...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TF Moisture Bricklet Configuration</b></em>'.
 *
 * @author Theo Weiss
 * @since 1.5.0
 *        <!-- end-user-doc -->
 ...
 * @generated
 */
public class TFMoistureBrickletConfigurationImpl extends TFBaseConfigurationImpl
        implements TFMoistureBrickletConfiguration {
    /**
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ModelPackage.TF_MOISTURE_BRICKLET_CONFIGURATION__MOVING_AVERAGE:
...
} // TFMoistureBrickletConfigurationImpl
