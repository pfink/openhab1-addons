 ...
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletColorImpl#getEnabledA <em>Enabled A</em>}
 * </li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletColorImpl#getTinkerforgeDevice
 * <em>Tinkerforge Device</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletColorImpl#getIpConnection <em>Ip
 * Connection</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletColorImpl#getConnectedUid <em>Connected
 * Uid</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletColorImpl#getPosition <em>Position</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletColorImpl#getDeviceIdentifier <em>Device
 * Identifier</em>}</li>
 ...
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletColorImpl#getMsubdevices
 * <em>Msubdevices</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletColorImpl#getTfConfig <em>Tf Config</em>}
 * </li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletColorImpl#getDeviceType <em>Device Type</em>}
 * </li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletColorImpl#getGain <em>Gain</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletColorImpl#getIntegrationTime <em>Integration
 * Time</em>}</li>
 * </ul>
 *
 * @generated
...
public class MBrickletColorImpl extends MinimalEObjectImpl.Container implements MBrickletColor {
    ...
    public void setLogger(Logger newLogger) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_COLOR__LOGGER, oldLogger,
                    logger));
    }
    ...
    public void setEnabledA(AtomicBoolean newEnabledA) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_COLOR__ENABLED_A, oldEnabledA,
                    enabledA));
    }
    ...
    public void setIpConnection(IPConnection newIpConnection) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_COLOR__IP_CONNECTION,
    ...
    public void setConnectedUid(String newConnectedUid) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_COLOR__CONNECTED_UID,
    ...
    public void setPosition(char newPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_COLOR__POSITION, oldPosition,
                    position));
    }
    ...
    public void setDeviceIdentifier(int newDeviceIdentifier) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_COLOR__DEVICE_IDENTIFIER,
    ...
    public MBrickd getBrickd() {
        if (eContainerFeatureID() != ModelPackage.MBRICKLET_COLOR__BRICKD)
            return null;
    ...
    public void setBrickd(MBrickd newBrickd) {
        if (newBrickd != eInternalContainer()
                || (eContainerFeatureID() != ModelPackage.MBRICKLET_COLOR__BRICKD && newBrickd != null)) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_COLOR__BRICKD, newBrickd,
                    newBrickd));
    }
    ...
    public EList<BrickletColorDevice> getMsubdevices() {
        if (msubdevices == null) {
            msubdevices = new EObjectContainmentWithInverseEList<BrickletColorDevice>(BrickletColorDevice.class, this,
                    ModelPackage.MBRICKLET_COLOR__MSUBDEVICES, ModelPackage.MSUB_DEVICE__MBRICK) {
    ...
    public NotificationChain basicSetTfConfig(BrickletColorConfiguration newTfConfig, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    ModelPackage.MBRICKLET_COLOR__TF_CONFIG, oldTfConfig, newTfConfig);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setIntegrationTime(Short newIntegrationTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_COLOR__INTEGRATION_TIME,
            ...
            if (tfConfig.eIsSet(tfConfig.eClass().getEStructuralFeature("integrationTime"))) {
                ...
                switch (integrationTimeConfig) {
                    ...
                    case 4:
                        ...
                        break;
                    default:
                        logger.error("invalid integrationTime value {}; using default integrationTime",
                                integrationTimeConfig);
                        break;
                }
            }
        }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.MBRICKLET_COLOR__INTEGRATION_TIME:
                return INTEGRATION_TIME_EDEFAULT == null ? integrationTime != null
                        : !INTEGRATION_TIME_EDEFAULT.equals(integrationTime);
        }
        ...
        if (baseClass == MSubDeviceHolder.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSUB_DEVICE_HOLDER__MSUBDEVICES:
                    return ModelPackage.MBRICKLET_COLOR__MSUBDEVICES;
                default:
                    return -1;
            }
        }
        if (baseClass == MTFConfigConsumer.class) {
            switch (baseFeatureID) {
                case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG:
                    return ModelPackage.MBRICKLET_COLOR__TF_CONFIG;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MSubDeviceHolder.class) {
            switch (baseOperationID) {
                case ModelPackage.MSUB_DEVICE_HOLDER___INIT_SUB_DEVICES:
                    return ModelPackage.MBRICKLET_COLOR___INIT_SUB_DEVICES;
                default:
                    return -1;
            }
        }
