...
public abstract class AbstractLightwaveRfCommand implements LightwaveRFCommand {
    ...
    public String getMessageString(LightwaveRfMessageId messageId, String roomId, String function) {
        return messageId.getMessageIdString() + ",!R" + roomId + "F" + function + "\n";
    }

    public String getMessageString(LightwaveRfMessageId messageId, String roomId, String function, int parameter) {
    ...
    public String getDeviceRegistrationMessageString(LightwaveRfMessageId messageId, String function,
            String parameter) {
