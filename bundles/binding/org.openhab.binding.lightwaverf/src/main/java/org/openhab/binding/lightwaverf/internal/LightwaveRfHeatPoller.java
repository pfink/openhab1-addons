...
public class LightwaveRfHeatPoller {
    ...
    public LightwaveRfHeatPoller(LightwaveRfWifiLink sender, LightwaverfConvertor convertor) {
        this.sender = sender;
    ...
    public void addRoomToPoll(String itemName, String roomId, int requestedPoll) {
        ...
        ScheduledFuture<?> future = executor.scheduleWithFixedDelay(new SendMessageThread(roomId), 0, currentPoll,
                TimeUnit.SECONDS);
