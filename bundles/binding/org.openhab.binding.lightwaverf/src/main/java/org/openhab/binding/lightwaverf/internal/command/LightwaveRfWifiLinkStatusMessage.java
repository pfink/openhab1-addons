 ...
 * @since 1.8.0
 */
public class LightwaveRfWifiLinkStatusMessage extends AbstractLightwaveRfJsonMessage
    ...
    public String getLightwaveRfCommandString() {
        return new StringBuilder("*!{").append("\"trans\":").append(getMessageId().getMessageIdString())
                ...
                .append(",\"type\":\"").append(type).append(",\"prod\":\"").append(prod).append(",\"fw\":\"")
                .append(firmware).append(",\"uptime\":\"").append(uptime).append(",\"timeZone\":\"").append(timeZone)
                .append(",\"lat\":\"").append(latitude).append(",\"long\":\"").append(longitude)
                .append(",\"duskTime\":\"").append(getLightwaveDateFromJavaDate(duskTime)).append(",\"dawnTime\":\"")
                .append(getLightwaveDateFromJavaDate(dawnTime)).append(",\"tmrs\":\"").append(tmrs)
                .append(",\"evns\":\"").append(envs).append(",\"run\":\"").append(run).append(",\"macs\":\"")
                .append(macs).append(",\"ip\":\"").append(ip).append(",\"devs\":\"").append(devs).append("}")
                .toString();
    }
    ...
    public static boolean matches(String message) {
        if (message.contains("\"type\":\"hub\"") && message.contains("\"prod\":\"wfl\"") && message.contains("lat")
