...
public class SoulissT31 extends SoulissGenericTypical {
    ...
    public SoulissT31(DatagramSocket _datagramsocket, String sSoulissNodeIPAddressOnLAN, int iIDNodo, int iSlot,
            String sOHType) {
        super();
    ...
    public void CommandSEND(short command, short B1, short B2) {
        SoulissCommGate.sendFORCEFrameT31SetPoint(SoulissNetworkParameter.datagramsocket,
                SoulissNetworkParameter.IPAddressOnLAN, this.getSoulissNodeID(), this.getSlot(), command, B1, B2);
    }
    // T31 Commands
    //
    ...
    public State getOHStateMeasuredValue() {
        String sOHState = StateTraslator.statesSoulissToOH(this.getsItemTypeMeasuredValue(), this.getType(),
                (short) this.getState());
        if (sOHState == null) {
    ...
    public State getOHStateSetpointValue() {
        String sOHState = StateTraslator.statesSoulissToOH(this.getsItemTypeSetpointValue(), this.getType(),
                (short) this.getState());
        if (sOHState == null) {
            if (!Float.isNaN(this.getState())) {
    ...
    public void setsItemNameMeasuredValue(String sItemNameMeasuredValue) {
    ...
    public void setsItemNameSetpointValue(String sItemNameSetpointValue) {
