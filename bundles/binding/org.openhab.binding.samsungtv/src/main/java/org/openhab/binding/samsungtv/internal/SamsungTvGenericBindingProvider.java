 ...
 * @since 1.2.0
 */
public class SamsungTvGenericBindingProvider extends AbstractGenericBindingProvider
        implements SamsungTvBindingProvider {

    static final Logger logger = LoggerFactory.getLogger(SamsungTvGenericBindingProvider.class);
    ...
    protected void parseBindingConfig(String bindingConfigs, SamsungTvBindingConfig config)
            throws BindingConfigParseException {
