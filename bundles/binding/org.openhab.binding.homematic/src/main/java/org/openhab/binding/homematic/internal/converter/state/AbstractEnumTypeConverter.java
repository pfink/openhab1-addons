...
public abstract class AbstractEnumTypeConverter<T extends State> extends AbstractTypeConverter<T> {
    ...
    protected String toString(T type, HmValueItem hmValueItem) {
        ...
        return type.toString().equalsIgnoreCase(getFalseType().toString()) ? getFalseType().toString()
                : getTrueType().toString();
    }
    ...
    protected T fromString(HmValueItem hmValueItem) {
        return createEnumType(hmValueItem,
                getFalseType().toString().equalsIgnoreCase(hmValueItem.getValue().toString()));
    }
