 ...
 * {@link FritzboxBindingProvider} service as well.
 * </p>
 *
 * <p>
...
public class FritzboxGenericBindingProvider extends AbstractGenericBindingProvider implements FritzboxBindingProvider {
     ...
     */
    protected FritzboxBindingConfig parseBindingConfig(Item item, String bindingConfig)
            throws BindingConfigParseException {
        if (ArrayUtils.contains(FritzboxBindingProvider.TYPES, bindingConfig)
                || ArrayUtils.contains(FritzboxBindingProvider.TYPES, bindingConfig.substring(0, 3))) {
