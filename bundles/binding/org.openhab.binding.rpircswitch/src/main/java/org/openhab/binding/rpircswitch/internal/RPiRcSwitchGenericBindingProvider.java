 ...
 * @since 1.8.0
 */
public class RPiRcSwitchGenericBindingProvider extends AbstractGenericBindingProvider
        implements RPiRcSwitchBindingProvider {
    ...
    public void processBindingConfiguration(String context, Item item, String bindingConfig)
        ...
        if (item instanceof SwitchItem) {
            ...
            if (deviceAddressString == null || deviceAddressString.isEmpty() || groupAddressString == null
                    || groupAddressString.isEmpty()) {
                LOGGER.error("The item configuration '" + bindingConfig
