...
public class LightwaveRfBindingTest {
    ...
    public void testInternalReceiveCommand() {
        ...
        when(mockLightwaveRfConvertor.convertToLightwaveRfMessage("2", "3", LightwaveRfType.SWITCH, OnOffType.ON))
                .thenReturn(mockLightwaveRfCommand);
    ...
    public void testVersionMessageRecevied() {
        ...
        when(mockBindingProvider.getBindingItemsForType(LightwaveRfType.VERSION))
                .thenReturn(Arrays.asList("MyVersion"));
