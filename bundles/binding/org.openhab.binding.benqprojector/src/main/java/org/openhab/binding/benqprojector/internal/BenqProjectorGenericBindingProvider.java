 ...
 * @since 1.6.0
 */
public class BenqProjectorGenericBindingProvider extends AbstractGenericBindingProvider
        implements BenqProjectorBindingProvider {
    ...
    public void processBindingConfiguration(String context, Item item, String bindingConfig)
        ...
        if (bindingConfig.equalsIgnoreCase("power")) {
            ...
            throw new BindingConfigParseException(
                    "Unable to parse '" + bindingConfig + "' to create a valid item binding.");
        }
