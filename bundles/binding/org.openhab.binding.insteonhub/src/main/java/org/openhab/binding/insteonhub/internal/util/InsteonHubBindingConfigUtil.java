...
public class InsteonHubBindingConfigUtil {
    ...
    public static InsteonHubBindingConfig getConfigForItem(Collection<InsteonHubBindingProvider> providers,
            String itemName) {
        // check each provider
    ...
    public static Collection<InsteonHubBindingConfig> getConfigsForDevice(
            Collection<InsteonHubBindingProvider> providers, String hubId, String deviceId) {
