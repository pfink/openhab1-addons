...
public class CRC16 {
    ...
    private static final int[] TABLE = { 0x0000, 0x1021, 0x2042, 0x3063, 0x4084, 0x50a5, 0x60c6, 0x70e7, // 0x00
    ...
    public static boolean check(byte[] data, int offset, int length) {
    ...
    public static boolean check(byte[] data, byte[] crc) {
        if (crc.length != 2) {
    ...
    public void add(byte b) {
        work = (TABLE[(b ^ (work >>> 8)) & 0xff] ^ (work << 8)) & 0xffff;
    }
    ...
    public byte[] getCrc() {
        return new byte[] { (byte) (work >>> 8 & 0xff), (byte) (work & 0xff) };
    }
